...
Scream = function Scream (config) {
    ...
    scream._getMinimalViewHeight = function () {
        ...
        specs = [
            ...
            //  name
            // ]
            // [1280, 1762, 1920, 1280, 736, 414, 3, 'iPhone 4'],
        ...
        // console.log(global.screen.width, global.screen.height, global.devicePixelRatio);
    ...
    scream.isMinimalView = function () {
        // console.log("check:"+window.innerHeight+" "+ window.screen.width);
        
        // It is enough to check the height, because the viewport is based on width.
        return window.innerHeight  == window.screen.width;
