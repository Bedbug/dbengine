...
$.widget( "ui.droppable", {
	...
	_create: function() {
		...
		this._addToManager( o.context );

		o.addClasses && this._addClass( "ui-droppable" );

	},

	_addToManager: function( context ) {

		// Add the reference and positions to the manager
		$.ui.ddmanager.droppables[ context ] = $.ui.ddmanager.droppables[ context ] || [];
		$.ui.ddmanager.droppables[ context ].push( this );
	},
	...
	_destroy: function() {
		var drop = $.ui.ddmanager.droppables[ this.options.context ];
		...
		this.element
			...
			.each( function() {
				...
				if (
					...
					inst.options.context === draggable.options.context &&
					inst.accept.call(
...
$.ui.ddmanager = {
	...
	prepareOffsets: function( t, event ) {
		...
		var i, j,
			m = $.ui.ddmanager.droppables[ t.options.context ] || [],
	...
	drop: function( draggable, event ) {
		...
		$.each( ( $.ui.ddmanager.droppables[ draggable.options.context ] || [] ).slice(), function() {
	...
	drag: function( draggable, event ) {
		...
		$.each( $.ui.ddmanager.droppables[ draggable.options.context ] || [], function() {

			if ( this.options.disabled || this.greedyChild || !this.visible ) {
				return;
			}

			var parentInstance, context, parent,
			...
			if ( this.options.greedy ) {
				...
				// find droppable parents with same context
				context = this.options.context;
				parent = this.element.parents( ":data(ui-droppable)" ).filter( function() {
					return $( this ).droppable( "instance" ).options.context === context;
				} );
...
var widgetsSortable = $.widget( "ui.sortable", $.ui.mouse, {
	...
	_rearrange: function( event, i, a, hardRefresh ) {
		...
		// 3. on the local context, we copy the counter variable, and check in the timeout,
		...
		$.each( this.options.items, function( widget, selector ) {
			...
			that.element
				...
				.each( function() {
					...
					// polluting the variable options which has a wider context than a single widget.
		...
		for ( row = 0; row < numMonths[ 0 ]; row++ ) {
			...
			for ( col = 0; col < numMonths[ 1 ]; col++ ) {
				...
				for ( dow = 0; dow < 7; dow++ ) { // days of the week
					day = ( dow + firstDay ) % 7;
					thead += "<th context='col'" + ( ( dow + firstDay + 6 ) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "" ) + ">" +
