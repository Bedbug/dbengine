Theme = {
    ...
    create: function(context) {
        ...
        // X2 Background
        var x2Bg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-1', 'thunderstormA1.jpg');
        x2Bg.alpha = 1;
        ...
        var A2 = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-2', 'thunderstormA2.jpg');
        A2.alpha = 0;
        ...
        // X3 Background
        var x3Bg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-2', 'thunderstormB1.jpg');
        x3Bg.alpha = 1;
        ...
        var B2 = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-3', 'thunderstormB2.jpg');
        B2.alpha = 0;
        ...
        var B3 = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-3', 'thunderstormB3.jpg');
        B3.alpha = 0;
        ...
        // x4 Background
        var x4Bg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-2', 'thunderstormC1.jpg');
        x4Bg.alpha = 1;
        ...
        var C2 = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-3', 'thunderstormC2.jpg');
        C2.alpha = 0;
        ...
        var C3 = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-3', 'thunderstormC3.jpg');
        C3.alpha = 0;
        ...
        var L1 = context.game.add.sprite(130, 160, 'extras-0', 'Lightning_A_001.png');
        L1.angle = -25;
        ...
        var L2 = context.game.add.sprite(300, 0, 'extras-0', 'Lightning_B_002.png');
        ...
        // x5 Background
        var x5Bg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-2', 'thunderstormD1.jpg');
        x5Bg.alpha = 1;
        ...
        var D2 = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-3', 'thunderstormD2.jpg');
        D2.alpha = 0;
        ...
        var D3 = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-3', 'thunderstormD3.jpg');
        D3.alpha = 0;
        ...
        var L3 = context.game.add.sprite(130, 160, 'extras-0', 'Lightning_B_001.png');
        L3.angle = -25;
        ...
        var L4 = context.game.add.sprite(300, 0, 'extras-0', 'Lightning_B_002.png');
        ...
        // Clouds
        var cloudBg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-0', "clouds_bg.jpg");
        ...
        // Storm
        var stormBg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-0', 'storm_bg.jpg');
        stormBg.alpha = 1;
        ...
        // Snow
        var snowBg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-0', 'snow_bg.jpg');
        snowBg.alpha = 1;
        ...
        // Sun    
        var sunBg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-1', 'sun_bg.jpg');
        sunBg.alpha = 1;
        ...
        var sun = context.game.add.sprite(context.game.width, 0, 'extras-0', 'sun.png');
        ...
        // Wind    
        var windBg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras-4', 'wind_bg.jpg');
        windBg.alpha = 1;
        ...
        // Tree Wind Animation
        var windTree = context.game.add.sprite(0, 275, "windytree", "Tree_wind0000.png");
        windTree.scale.setTo(0.86, 0.86);
        ...
        // this.logoTitle.scale.setTo(0.67, 0.67)
        this.logoTitle.anchor.setTo(0, 0.5);
        this.logoTitle.scale.setTo(0.90, 0.90);
        ...
        var CoinParticle = (function() {
            ...
            var CoinParticle = function(game, x, y) {
                Phaser.Particle.call(this, game, x, y, 'extras-0');
        ...
        //moneyEmitter.start(true,3000,null,50);
        ...
        //moneyEmitter.start(false, 5000, 50);
        ...
        // context.playBigWin();
        //context.closeMultis();
        //context.openMulti("state4");

        // // Add Ambience
        // context.ambient = context.game.add.audio('sun_audio');
        // context.ambient.volume = 0.1;
        // context.ambient.loopFull(0.6);
        // context.ambient.play();
    ...
    createAnticipationAnimation: function(reelName, x, y) {
        var anticipation = bedbugGameCore.game.add.sprite(x, y - 4, "extras2", "Anticipation_0000.png");
        anticipation.anchor.setTo(0.5, 0);
        anticipation.scale.setTo(0, 1.1);
    ...
    requiresBonusStageUpgrade: function(serverResult, context) {
        ...
        if (bedbugGameCore.bonus_stage != serverResult.ActionLevel) {
            ...
            var level = parseInt(serverResult.ActionLevel);

            if (bedbugGameCore.bonus_stage < level) {
                if (LOBBY_PROXY)
                    LOBBY_PROXY.SendMessage(LOBBY_MESSAGES_ENUM.LOBBY_MESSAGE_STATE_ACTION_ENTER_INNER_FREE_SPIN);
            }
            else {
                if (LOBBY_PROXY)
                    LOBBY_PROXY.SendMessage(LOBBY_MESSAGES_ENUM.LOBBY_MESSAGE_STATE_ACTION_EXIT_INNER_FREE_SPIN);
            }
    ...
    weatherChange: function(weatherName, ignoreBonus, context) {
        // console.log(weatherName+" | "+ignoreBonus);
        // console.log("this.values.currentWeather:"+this.values.currentWeather);
        // console.log("Should we abort weather change (this.values.currentWeather == weatherName): "+(this.values.currentWeather == weatherName))
