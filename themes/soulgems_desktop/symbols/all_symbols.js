  ...
  slot1 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'h3-norm.png', 'h3', 'assets', "High", true, null, false, true);
    this.symbolName = "H3";
  ...
  slot2 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'h2-norm.png', 'h2', 'assets', "High", true, null, false, true);
    this.symbolName = "H2";
  }
  ...
  slot5 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'l3-norm.png', 'l3', 'assets', "Low", true, null, false, true);
    this.symbolName = "L3";
  }
  ...
  slot6 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'l2-norm.png', 'l2',  "assets", "Low", true, null, false, true);
    this.symbolName = "L2";
  }
  ...
  ************************************************************************/
   ...
   ************************************************************************/
  slot9 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'wild-norm.png', 'wild', 'assets', "Wild", true, null, false, true);
