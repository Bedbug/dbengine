  ...
  BBSlot.prototype.createStateLost = function() {
   ...
   this.BBSlotLost.frameName = this.winSprite + "-fail.png";
  ...
  BBSlot.prototype.createStateBlur = function() {
   ...
   this.BBSlotBlur.frameName = this.winSprite + "-blur.png";
  ...
  BBSlot.prototype.createStateWin = function() {
   ...
   //  this.winSymbol.frameName = this.winSprite+"-win.png";
   // } else {
   this.winSymbol = this.game.add.sprite(0, 0, this.Spritesheet + "2");
   this.winSymbol.animations.add("high", Phaser.Animation.generateFrameNames(this.winSprite + "-win-anim-", 1, 12, '.png', 2), 12, true);
   // }
   this.winSymbol.anchor.setTo(0.5, 0.5);

   this.sparkles = this.game.add.sprite(0, 0, this.Spritesheet);
   this.sparkles.anchor.setTo(.5, .5);
   this.sparkles.frameName = "win_sparkles_01.png";
   this.sparkles.animations.add("winSparkles", Phaser.Animation.generateFrameNames("win_sparkles_", 1, 20, '.png', 2), 24, true);
   ...
   // console.log(this.winSymbol.width);
   // console.log(this.winSymbol.height);
  ...
  BBSlot.prototype.setToWin = function() {
   ...
   // if (this.type == "Plain") {
   //this.winSymbol.animations.add("wild", Phaser.Animation.generateFrameNames(this.winSprite+"_anim", 0, 12, '.png', 5), 12, true);
   this.winSymbol.animations.play("high", 12, true);
   // }
