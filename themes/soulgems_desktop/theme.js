Theme = {
    ...
    create: function(context) {
        ...
        // Create the Color BGs
        this.bg0 = context.game.add.sprite(0, 0, "screens", "00.jpg");
        this.bg1 = context.game.add.sprite(0, 0, "screens", "10.jpg");
        this.bg2 = context.game.add.sprite(0, 0, "screens", "20.jpg");
        this.bg3 = context.game.add.sprite(0, 0, "screens", "30.jpg");
        this.bg4 = context.game.add.sprite(0, 0, "screens", "40.jpg");
        this.bg5 = context.game.add.sprite(0, 0, "screens", "50.jpg");
        
        this.RollingBgs = context.game.add.group();
        this.RollingBgs.add(this.bg0);
        this.RollingBgs.add(this.bg1);
        this.RollingBgs.add(this.bg2);
        this.RollingBgs.add(this.bg3);
        this.RollingBgs.add(this.bg4);
        this.RollingBgs.add(this.bg5);
        
        this.floatingBgs = [];
        this.floatingBgs.push(this.bg0);
        this.floatingBgs.push(this.bg1);
        this.floatingBgs.push(this.bg2);
        this.floatingBgs.push(this.bg3);
        this.floatingBgs.push(this.bg4);
        this.floatingBgs.push(this.bg5);

        for (var i = 0; i < this.floatingBgs.length; i++) {

            this.floatingBgs[i].alpha = 0;
            this.floatingBgs[i].width = context.game.width;
            this.floatingBgs[i].height = context.game.height;

        }

        this.floatingBgs[0].alpha = 1;



        context.game.time.events.loop(Phaser.Timer.SECOND * 0.5, rollingBg, this);
        this.bgCount = 1;
        this.countMinus = 0;
        rollingBg();
        ...
        function rollingBg() {
            ...
            // console.log(that.bg0);
            // console.log(that.floatingBgs[0]);
            // console.log(that.bgCount);
            // console.log(that.countMinus);
            // console.log(that.bgCount, "Opens");
            // console.log(that.countMinus,"Closing");
            that.RollingBgs.bringToTop(that.floatingBgs[that.bgCount]);
            context.game.add.tween(that.floatingBgs[that.bgCount]).to({ alpha: 1 }, 500, Phaser.Easing.Linear.None, true);
            context.game.add.tween(that.floatingBgs[that.countMinus]).to({ alpha: 0 }, 500, Phaser.Easing.Linear.None, true, 500);
            // context.game.add.tween(that.floatingBgs[that.countMinus]).to( { alpha: 0 }, 10000, Phaser.Easing.Linear.None, true);

            that.bgCount++;
            that.countMinus++;

            if (that.bgCount == 5) that.bgCount = 0;
            if (that.countMinus == 5) that.countMinus = 0;
        ...
        this.game_background = context.game.add.sprite(0, 0, 'screens');
        this.game_background.frameName = "background_full.png";
