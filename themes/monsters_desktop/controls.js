Controls = {
    create: function(context) {
        ...
        // Play Button
        this.play_button = context.game.add.button(643, 659, 'assets', context.play_spin, context, 'button-spin-over.png', 'button-spin-active.png', 'button-spin-pressed-01.png', 'button-spin-active.png');
        ...
        this.play_button_off = context.game.add.sprite(643, 659, 'assets');
        ...
        this.countplay_button_stop = context.game.add.button(643, 659, "assets", context.stop_spin, context, 'button-spin-over.png', 'button-spin-active.png', 'button-spin-pressed-01.png', 'button-spin-active.png');
        ...
        var buttonTextStyle = {
            font: " 20px ParkLaneNF",
            fill: "#fff",
            align: "center",
            // stroke : '#000',
            // strokeThickness : 4
        }
        var buttonTextSmallStyle = {
            font: " 16px ParkLaneNF",
            fill: "#fff",
            align: "center",
            // stroke : '#000',
            // strokeThickness : 4
        ...
        this.autoplay_button = context.game.add.button((context.game.width / 2) - 131, 640, 'assets', this.openAutoplayPanel, context, 'button-autoplay-over.png', 'button-autoplay-active.png', 'button-autoplay-pressed.png', 'button-autoplay-active.png');
        this.autoplay_button.anchor.setTo(0.5, 0.5);

        this.autoplay_text = context.game.add.text((context.game.width / 2) - 150, 640, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_LABEL"), buttonTextStyle);
        this.autoplay_text.anchor.setTo(0.5, 0.5);
        this.autoplay_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        this.autoplayOff_button = context.game.add.button((context.game.width / 2) - 131, 640, 'assets');
        this.autoplayOff_button.frameName = "button-autoplay-inactive.png";
        this.autoplayOff_button.anchor.setTo(0.5, 0.5);

        this.autoplayOff_text = context.game.add.text((context.game.width / 2) - 150, 640, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_LABEL"), buttonTextStyle);
        this.autoplayOff_text.anchor.setTo(0.5, 0.5);
        this.autoplayOff_text.alpha = .6;
        this.autoplayOff_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        this.auto_stopcount_text = context.game.add.text(50, 2, "0", {
        ...
        this.auto_stopcount_text.alpha = .6;
        ...
        this.autoplay_stop_button = context.game.add.button((context.game.width / 2) - 131, 640, 'assets', context.controls_stop_auto, context, 'button-autoplay-over.png', 'button-autoplay-active.png', 'button-autoplay-pressed.png', 'button-autoplay-active.png');
        this.autoplay_button.anchor.setTo(0.5, 0.5);
        this.autoplay_stop_button.anchor.setTo(0.5, 0.5);

        this.autoplay_stop_text = context.game.add.text(-18, 2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_LABEL"), buttonTextSmallStyle);
        this.autoplay_stop_text.anchor.setTo(0.5, 0.5);
        this.autoplay_stop_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        this.paytable_button = context.game.add.button((context.game.width / 2) - 131, 683, 'assets', context.showPayTable, context, 'button-paytable-over.png', 'button-paytable-active.png', 'button-paytable-pressed.png', 'button-paytable-active.png');
        this.paytable_button.anchor.setTo(0.5, 0.5);
        this.paytable_text = context.game.add.text((context.game.width / 2) - 131, 663, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_LABEL"), buttonTextStyle);
        this.paytable_text.anchor.setTo(0.5, 0.5);
        this.paytable_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        this.paytableOff_button = context.game.add.button((context.game.width / 2) - 131, 683, 'assets');
        this.paytableOff_button.frameName = "button-paytable-inactive.png";
        this.paytableOff_button.anchor.setTo(0.5, 0.5);

        this.paytableOff_text = context.game.add.text((context.game.width / 2) - 131, 663, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_LABEL"), buttonTextStyle);
        this.paytableOff_text.anchor.setTo(0.5, 0.5);
        this.paytableOff_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        this.max_bet_button = context.game.add.button((context.game.width / 2) + 137, 665, 'assets', context.setMaxBet, context, 'button-max-bet-over.png', 'button-max-bet-active.png', 'button-max-bet-pressed.png', 'button-max-bet-active.png');
        this.max_bet_button.anchor.setTo(0.5, 0.5);

        this.maxbet_text = context.game.add.text((context.game.width / 2) + 137, 645, bedbugGameCore.getLocalizedText('TXT_MAX_BET_LABEL'), maxBetStyle);
        this.maxbet_text.anchor.setTo(0.5, 0.5);
        this.maxbet_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        this.maxbet_text.resolution = 2;
        // this.max_bet_button.addChild(this.maxbet_text);
        this.buttonArray.push(this.max_bet_button);
        this.buttonArray.push(this.maxbet_text);

        this.max_betOff_button = context.game.add.button((context.game.width / 2) + 137, 665, 'assets');
        this.max_betOff_button.frameName = "button-max-bet-inactive.png";
        this.max_betOff_button.anchor.setTo(0.5, 0.5);

        this.maxbetOff_text = context.game.add.text((context.game.width / 2) + 137, 645, bedbugGameCore.getLocalizedText('TXT_MAX_BET_LABEL'), maxBetStyle);
        this.maxbetOff_text.anchor.setTo(0.5, 0.5);
        this.maxbetOff_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        this.buttonsOffArray.push(this.maxbetOff_text);


        // this.decr_level_button = new CustomButton(context.game, "-", 274, 644, 26, 24, bedbugGameCore.decrBetLevel);
        this.decr_level_button = context.game.add.button(195, 682, 'assets', bedbugGameCore.decrBetLevel, this, 'button-arrow-minus-over.png', 'button-arrow-minus-active.png', 'button-arrow-minus-pressed.png', 'button-arrow-minus-active.png');
        this.decr_level_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.decr_level_button);

        this.decr_levelOff_button = context.game.add.button(195, 682, 'assets');
        ...
        this.incr_level_button = context.game.add.button(303, 682, 'assets', bedbugGameCore.incrBetLevel, this, 'button-arrow-plus-over.png', 'button-arrow-plus-active.png', 'button-arrow-plus-pressed.png', 'button-arrow-plus-active.png');
        this.incr_level_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.incr_level_button);

        this.incr_levelOff_button = context.game.add.button(303, 682, 'assets');
        ...
        this.decr_coin_value_button = context.game.add.button(980, 682, 'assets', bedbugGameCore.decrCoinValue, this, 'button-arrow-minus-over.png', 'button-arrow-minus-active.png', 'button-arrow-minus-pressed.png', 'button-arrow-minus-active.png');
        this.decr_coin_value_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.decr_coin_value_button);

        this.decr_coin_valueOff_button = context.game.add.button(980, 682, 'assets');
        ...
        this.incr_coin_value_button = context.game.add.button(1082, 682, 'assets', bedbugGameCore.incrCoinValue, this, 'button-arrow-plus-over.png', 'button-arrow-plus-active.png', 'button-arrow-plus-pressed.png', 'button-arrow-plus-active.png');
        this.incr_coin_value_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.incr_coin_value_button);

        this.incr_coin_valueOff_button = context.game.add.button(1082, 682, 'assets');
        ...
        // Count Labels For Autoplay
        this.autoplay_label = new CustomLabel(context.game, bedbugGameCore.autoplay_count, 50, 0, 30, 25);
        this.autoplay_Stop_label = new CustomLabel(context.game, bedbugGameCore.autoplay_count, 50, 0, 30, 25);

        this.coins_label = new CustomLabel(context.game, "500000", -63, 8, 100, 40);
        this.coin_value_label = new CustomLabel(context.game, "0.01", 60, 8, 46, 40);
        ...
        this.betlevel_heading = context.game.add.text(250, 625, bedbugGameCore.getLocalizedText('TXT_BET_LEVEL_LABEL'), titleStyle);
        this.betlevel_heading.anchor.setTo(0.5, 0);
        this.betlevel_heading.resolution = 2;
        this.betlevel_heading.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);

        this.bet_heading = context.game.add.text(380, 625, bedbugGameCore.getLocalizedText("TXT_BET_LABEL"), titleStyle);
        this.bet_heading.anchor.setTo(0.5, 0);
        this.bet_heading.resolution = 2;
        this.bet_heading.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);

        this.coins_heading = context.game.add.text(905, 625, bedbugGameCore.getLocalizedText("TXT_COINS_LABEL"), titleStyle);
        this.coins_heading.anchor.setTo(0.5, 0);
        this.coins_heading.resolution = 2;
        this.coins_heading.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);

        this.coin_value_heading = context.game.add.text(1030, 625, bedbugGameCore.getLocalizedText("TXT_COIN_VALUE_LABEL"), titleStyle);
        this.coin_value_heading.anchor.setTo(0.5, 0);
        this.coin_value_heading.resolution = 2;
        this.coin_value_heading.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
    ...
    createAutoplayPanel: function(context) {
        ...
        this.autoplay_Panel_Bg = bedbugGameCore.game.add.sprite(170, -40, "assets", "autoplay-panel-01.png");
        ...
        this.autoplay_panel.x = bedbugGameCore.game.width / 2 - 375;
        ...
        this.autoplay_panel2.x = bedbugGameCore.game.width / 2 - 40;
        this.autoplay_panel2.y = bedbugGameCore.game.height / 2 + 83;
        ...
        var buttonTextStyle2 = {
            font: " 19px ParkLaneNF",
            fill: "#fff",
            align: "left",
            // stroke : '#000',
            // strokeThickness : 4
        ...
        this.autoplay_stepper = new StepperSmall(context.game, null, bedbugGameCore.autoplay_count, context.decrAutoplayCount, context.incrAutoplayCount, (width / 2) - 7, 30, 52, 130, true, {
                font: "bold 20px Arial",
                fill: "#FFF",
                heading: {
                    fill: "#FFF"
        ...
        // Title
        this.title_text = context.game.add.text(245, -25, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_LABEL"), buttonTextStyle);
        this.title_text.anchor.setTo(0.5, 0.5);
        this.title_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        this.advanced_text = context.game.add.text(245, 82, bedbugGameCore.getLocalizedText("TXT_ADVANCED_OPTIONS"), buttonTextStyle); //bedbugGameCore.getLocalizedText("TXT_ADVANCED_OPTIONS")
        this.advanced_text.anchor.setTo(0.5, 0.5);
        this.advanced_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        this.startAuto_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        // AUTOPLAY PANEL 2 TITLE
        // this.panel2Title = context.game.add.text( 250,26, bedbugGameCore.getLocalizedText("advanced"), {
        //     font: "35px Arial",
        //     fill: "#ffffff"
        // });
        // this.panel2Title.anchor.setTo(.5,.5);
        // this.panel2Title.setShadow( 2, 2, 'rgba(0,0,0,0.5)', 0 );
        // this.panel2Title.resolution = 2;
        ...
        // STOP AT ANY WIN
        this.stop_any_checkbox = new CheckΒoxSmall(5, -34, context.game, null, null, bedbugGameCore.autoplay_setup.on_win.checked, options, function(o) {
            bedbugGameCore.autoplay_setup.on_win.checked = o
        });
        this.stop_any_text = context.game.add.text(30, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_ANY"), buttonTextStyle2);
        this.stop_any_text.anchor.setTo(0);
        this.stop_any_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        // STOP AT WIN AMOUNT
        this.stop_win_amount = new CheckΒoxSmall(5, 2, context.game, null, bedbugGameCore.autoplay_setup.on_win_amount.value, bedbugGameCore.autoplay_setup.on_win_amount.checked, options, function(o, e) {
        ...
        this.stop_win_text = context.game.add.text(30, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_WIN_AMOUNT"), buttonTextStyle2);
        this.stop_win_text.anchor.setTo(0);
        this.stop_win_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        // STOP AT CASH
        this.stop_cash_amount = new CheckΒoxSmall(5, 36, context.game, null, bedbugGameCore.autoplay_setup.on_cash_amount.value, bedbugGameCore.autoplay_setup.on_cash_amount.checked, options, function(o, e) {
            bedbugGameCore.autoplay_setup.on_cash_amount.checked = o;
            if (e) bedbugGameCore.autoplay_setup.on_cash_amount.value = e
        }, null, null, null, inputStyle);

        this.stop_cash_text = context.game.add.text(30, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_WIN_CASH"), buttonTextStyle2);
        this.stop_cash_text.anchor.setTo(0);
        this.stop_cash_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        // STOP AT TIME
        this.stop_time = new CheckΒoxSmall(5, 72, context.game, null, bedbugGameCore.autoplay_setup.on_time.value, bedbugGameCore.autoplay_setup.on_time.checked, options2, function(o, e, m) {
            bedbugGameCore.autoplay_setup.on_time.checked = o;
            if (e && m) bedbugGameCore.autoplay_setup.on_time.value = [e, m];
        }, null, null, null, inputStyle2);

        this.stop_time_text = context.game.add.text(30, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_TIME"), buttonTextStyle2);
        this.stop_time_text.anchor.setTo(0);
        this.stop_time_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
        ...
        // STOP AT LOSE
        this.stop_lose = new CheckΒoxSmall(5, 108, context.game, null, bedbugGameCore.autoplay_setup.on_lose.value, bedbugGameCore.autoplay_setup.on_lose.checked, options, function(o, e) {
            bedbugGameCore.autoplay_setup.on_lose.checked = o;
            if (e) bedbugGameCore.autoplay_setup.on_lose.value = e;
        }, null, null, null, inputStyle);

        this.stop_lose_text = context.game.add.text(30, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_LOSE"), buttonTextStyle2);
        this.stop_lose_text.anchor.setTo(0);
        this.stop_lose_text.setShadow(0, 4, 'rgba(0,0,0,0.5)', 0);
    ...
    createPopupBG: function(game, width, height, shouldCloseExternalClick, style, onClickOutsideCallback, scope) {
        ...
        var panel_background = game.add.sprite(bedbugGameCore.game.width / 2, bedbugGameCore.game.height / 2, "screens", "Help_plate.png")
        panel_background.angle = -90
        panel_background.anchor.setTo(.5, .5)
        panel_background.scale.setTo(.9, .9)
    ...
    createPaytable: function(context) {
        ...
        var legal_text = context.game.add.text(panel_x + panel_width / 2, panel_y + panel_height - 160, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_GENERAL_INFO"), {
            font: '18px ParkLane',
            fill: '#fff',
            align: 'center',
            wordWrap: true,
        ...
        // wildText.scale.setTo(1.2);
        var wild = context.game.add.sprite((panel_width) - 130, 180, "assets", "Wild_Normal.png");
        wild.anchor.setTo(0.5, 0.5);
        // wild.scale.setTo(1.2);
        var wildanim = wild.animations.add("wild", Phaser.Animation.generateFrameNames("Wild_win", 0, 59, '.png', 4), 24, true);
        wildanim.play();
        var wildText = context.game.add.text(wild.x, wild.y + 120, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_05") + "\n" + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_06"), {
            'font': ' 22px ParkLane',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        wildText.resolution = 2;

        // SCATTER SYMBOL
        var scattersymbol = getSymbol(bedbugGameCore.symbolNameToID("SCAT"), left + 100, 180, 150, "20 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"), "15 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"), "10 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"));
        var scatter = context.game.add.sprite(left + 100, 180, "assets", "Scatter_Normal.png");
        scatter.anchor.setTo(0.5, 0.5);
        scatter.resolution = 2;
        // scatter.scale.setTo(1.2);
        var scatterText = context.game.add.text(left, scatter.y + 90, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_01"), {
            'font': ' 22px ParkLane',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        freeSpinsText.resolution = 2;

        var freeSpinsText2 = context.game.add.text(panel_width / 2 + 45, 380, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_03") + "\n" + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_04"), {
            'font': ' 22px ParkLane',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        var symbol1 = getSymbol(bedbugGameCore.symbolNameToID("P5"), left + 95, 200, 130, getAward("P5", "5"), getAward("P5", "4"), getAward("P5", "3"), false);
        var symbol2 = getSymbol(bedbugGameCore.symbolNameToID("P4"), left + 350, 200, 130, getAward("P4", "5"), getAward("P4", "4"), getAward("P4", "3"));
        var symbol3 = getSymbol(bedbugGameCore.symbolNameToID("P3"), left + 615, 200, 130, getAward("P3", "5"), getAward("P3", "4"), getAward("P3", "3"));
        var symbol4 = getSymbol(bedbugGameCore.symbolNameToID("P2"), left + 205, 390, 130, getAward("P2", "5"), getAward("P2", "4"), getAward("P2", "3"));
        var symbol5 = getSymbol(bedbugGameCore.symbolNameToID("P1"), left + 500, 390, 130, getAward("P1", "5"), getAward("P1", "4"), getAward("P1", "3"));
        screen3.add(symbol1);
        screen3.add(symbol2);
        screen3.add(symbol3);
        screen3.add(symbol4);
        ...
        var symbol6 = getSymbol(bedbugGameCore.symbolNameToID("L5"), left + 95, 200, 130, getAward("L5", "5"), getAward("L5", "4"), getAward("L5", "3"));
        var symbol7 = getSymbol(bedbugGameCore.symbolNameToID("L4"), left + 350, 200, 130, getAward("L4", "5"), getAward("L4", "4"), getAward("L4", "3"));
        var symbol8 = getSymbol(bedbugGameCore.symbolNameToID("L3"), left + 605, 200, 130, getAward("L3", "5"), getAward("L3", "4"), getAward("L3", "3"));
        var symbol9 = getSymbol(bedbugGameCore.symbolNameToID("L2"), left + 215, 380, 130, getAward("L2", "5"), getAward("L2", "4"), getAward("L2", "3"));
        var symbol10 = getSymbol(bedbugGameCore.symbolNameToID("L1"), left + 495, 380, 130, getAward("L1", "5"), getAward("L1", "4"), getAward("L1", "3"));
        screen4.add(symbol6);
        screen4.add(symbol7);
        screen4.add(symbol8);
        screen4.add(symbol9);
        ...
        var paylines = context.game.add.sprite(-80, 30, "paylines");
        // paylines.anchor.setTo(.5);
        paylines.scale.setTo(.80);
        ...
        // CLOSE BUTTON
        var close_button = bedbugGameCore.game.add.button((panel_width / 2) + 150, panel_y + panel_height - 30, 'mobile', hidePaytable, this, 'btn_close_pressed.png', 'btn_close_pressed.png', 'btn_close_active.png');
        close_button.anchor.setTo(.5, .5);
        close_button.scale.setTo(0.5, 0.5);
        close_button.alpha = 0;

        this.close_button2 = bedbugGameCore.game.add.button(333, 569, 'assets', hidePaytable, this, 'paytable-home-button-over.png', 'paytable-home-button-active.png', 'paytable-home-button-pressed.png', 'paytable-home-button-active.png');
        ...
        // screen1Temp.input.enableDrag();
        // screen1Temp.events.onDragStop.add(onDragStop, this);
        ...
        var client_version = context.game.add.text(panel_x + panel_width - 70, close_button.y - 10, "Client v" + bedbugGameCore.game_specs.version, {
            font: '14px Arial',
            fill: '#fff',
            align: 'left'
        })
