Theme = {
    ...
    create: function(context) {
        ...
        // Bonus BG
        this.bonusBg = context.game.add.sprite(0, 0, 'screens');
        ...
        this.lightLeft = context.game.add.sprite(0, 720, 'screens', "FreeSpin_.png");
        ...
        this.lightRight = context.game.add.sprite(1280, 720, 'screens', "FreeSpin_.png");
        ...
        // FREE SPINS
        this.freeSpins = context.game.add.sprite((context.game.width / 2), (context.game.height / 2) - 60, "screens")
        ...
        context.winGroupParticles = context.game.add.group();
        ...
        context.winGroupParticles.add(context.moneyEmitter);
    ...
    playBigWin: function(context, callback) {
        ...
        context.winGroupParticles.visible = true;
        this.bigwin.alpha = 1;
        
        context.winGroupParticles.alpha = 1;
        ...
        context.game.world.bringToTop(context.winGroupParticles);
    ...
    hideBigWin: function(context) {
        ...
        var hideParticles = context.game.add.tween(context.winGroupParticles).to({
            alpha: 0
        }, 600, Phaser.Easing.Quadratic.Out, true);
        ...
        hidebg.onComplete.add(function() {
            ...
            // context.winGroupParticles.visible = false;
    ...
    createLine: function(line, slim, lineContext, context) {
        ...
        _.forEach(line.slots, function(row) {
            ...
            if (reelPoint == 3) {
                lineContext.pointsbg = context.game.add.sprite(slot.x, slot.y, "screens", "WinTab_.png")
    ...
    createWinningBanners: function(context) {
        ...
        bedbugGameCore.winLabel = context.game.add.sprite(0, (context.game.height / 2) - 52, 'screens', 'win-small.png');
