Sounds = {
    ...
    create: function(context) {
        ...
        // context.game.sound.play('ambiance_rain_loop', bedbugGameCore.sound_effects_volume, true);
        ...
        function ON_SCATTER_APPEAR_SOUND() {
            ...
            if (context.game.cache.checkSoundKey('scatter_appear_' + scatters_appeard))
        ...
        function ON_EACH_ANTICIPATION_END() {
            ...
            if (bedbugGameCore.scatters_appeard < 3 && context.game.cache.checkSoundKey('evnt_anticipation_failed')) {
        ...
        // Here we need to make various chaneges in order to be according to specs
        
        // Slot win big - is raised when we have a big win
        // We should not have loop here(?)
        ...
        // On change magnitude of big win
         bedbugEventsSystem.addListener('ON_SLOT_WIN_BIG_MAGNITUDE_CHANGE', ON_SLOT_WIN_BIG_MAGNITUDE_CHANGE);

        function ON_SLOT_WIN_BIG_MAGNITUDE_CHANGE () {
            context.game.sound.play('win_magnitude_change_impact', bedbugGameCore.sound_effects_volume);
        };
