Splash = {
    create: function(context) {
        ...
        var fts = context.game.add.sprite(context.game.width / 2, context.game.height / 2 + 37, "screens","Help_plate.png") 
        fts.anchor.setTo(.5);
        fts.angle = 90;
        fts.smoothed = false;
    ...
    //   var title_text = context.game.add.bitmapText((context.game.width / 2), (context.game.height / 2) -250, "pointfonts",bedbugGameCore.getLocalizedText("MSG_MAX_WIN").replace("$(1)", bedbugGameCore.numberWithSpaces((5600 * MaxBetLevel))), 60);
