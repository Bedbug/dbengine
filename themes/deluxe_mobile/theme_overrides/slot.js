  ...
  BBSlot.prototype.createStates = function() {
   ...
   //  bedbugGameCore.showSymbolInfo(this.symbolName, this.getworldposition);
   //  bedbugGameCore.game.input.onDown.add(function() {
   //   bedbugGameCore.removeSymbolInfo();
   //   bedbugGameCore.game.input.onDown.remove(showSymbolInfo, this);
   //  }, this);
   // }
  ...
  BBSlot.prototype.createStateLost = function() {
   ...
   this.BBSlotLost.frameName = this.winSprite + "-Lose.png";
  ...
  BBSlot.prototype.createStateWin = function() {
   ...
   // } else {
   this.winSymbol = this.game.add.sprite(0, 0, (this.Spritesheet));
   this.winSymbol.frameName = (this.winSprite + "-Win-01.png");
   // }
   this.winSymbol.anchor.setTo(0.5, 0.5);

   // if (this.type == "Scatter") {
   //this.winSymbol.frameName = this.winSprite+".png";
   this.winSymbol.animations.add("win", Phaser.Animation.generateFrameNames(this.winSprite + "-Win-", 1, 20, '.png', 2), 24, true);
  ...
  BBSlot.prototype.setToWin = function() {
   ...
   // if (this.type == "Plain") {
   //this.winSymbol.animations.add("wild", Phaser.Animation.generateFrameNames(this.winSprite+"_anim", 0, 12, '.png', 5), 12, true);
   this.winSymbol.play("win", 24, true);
   // }
