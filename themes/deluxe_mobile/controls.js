Controls = {
    create: function(context) {
        ...
        this.home_button = context.game.add.button(20, 10, 'mobile', bedbugGameCore.GO_HOME, bedbugGameCore, 'Home_Active.png', 'Home_Active.png', 'Home_Pressed.png');
        this.controlsGroup.addChild(this.home_button);
        this.buttonArray.push(this.home_button);

        this.homeOff_button = context.game.add.button(20, 10, 'mobile');
        ...
        // // SETTINGS BUTTON
        this.settings_button = context.game.add.button(1180, 10, 'mobile', this.openOptionsPanel, this, 'Options_Active.png', 'Options_Active.png', 'Options_Pressed.png');
        this.controlsGroup.addChild(this.settings_button);
        this.buttonArray.push(this.settings_button);

        this.settingsOff_button = context.game.add.button(1180, 10, 'mobile');
    ...
    createPaytable: function(context) {
        ...
        // var titleText = context.game.add.text( 300, 100, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_01"), {
        //     'font': ' 22px Arial',
        //     'fill': '#fff',
        //     'align': 'center',
        //     wordWrap: true,
        //     wordWrapWidth: "400"
        // });
        var titleText = context.game.add.text(430, 145, bedbugGameCore.getLocalizedText("243 ways to win!"), {
            'font': ' 55px Arial',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        // WILD SYMBOL
        var winSymbol = context.game.add.sprite((panel_width / 2) - 180, 290, "assets", "15x3-win-layout.png")
        ...
        //     wordWrapWidth: "400"
        // });
        var wildText = context.game.add.text(winSymbol.x, winSymbol.y + 130, bedbugGameCore.getLocalizedText("Win"), {
            'font': ' 45px Arial',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        // SCATTER SYMBOL
        var loseSymbol = context.game.add.sprite((panel_width / 2) + 280, 290, "assets", "15x3-no-win-layout.png")
        ...
        //     wordWrapWidth: "400"
        // });
        var scatterText = context.game.add.text(loseSymbol.x, loseSymbol.y + 130, bedbugGameCore.getLocalizedText("No Win"), {
            'font': '45px Arial',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        var symbol1 = getSymbol(bedbugGameCore.symbolNameToID("P4"), left + 50, 210, 130, getAward("P4", "5"), getAward("P4", "4"), getAward("P4", "3"));
        var symbol2 = getSymbol(bedbugGameCore.symbolNameToID("P3"), left + 270, 210, 130, getAward("P3", "5"), getAward("P3", "4"), getAward("P3", "3"));
        var symbol3 = getSymbol(bedbugGameCore.symbolNameToID("P2"), left + 480, 210, 130, getAward("P2", "5"), getAward("P2", "4"), getAward("P2", "3"));
        var symbol4 = getSymbol(bedbugGameCore.symbolNameToID("P1"), left + 700, 210, 130, getAward("P1", "5"), getAward("P1", "4"), getAward("P1", "3"));
        // var symbol5 = getSymbol(bedbugGameCore.symbolNameToID("M1"), left + 615, 390, 130, 250, 40, 20);
        var symbol7 = getSymbol(bedbugGameCore.symbolNameToID("L4"), left + 50, 390, 130, getAward("L4", "5"), getAward("L4", "4"), getAward("L4", "3"));
        var symbol8 = getSymbol(bedbugGameCore.symbolNameToID("L3"), left + 270, 390, 130, getAward("L3", "5"), getAward("L3", "4"), getAward("L3", "3"));
        var symbol9 = getSymbol(bedbugGameCore.symbolNameToID("L2"), left + 480, 390, 130, getAward("L2", "5"), getAward("L2", "4"), getAward("L2", "3"));
        var symbol10 = getSymbol(bedbugGameCore.symbolNameToID("L1"), left + 700, 390, 130, getAward("L1", "5"), getAward("L1", "4"), getAward("L1", "3"));
        ...
        var client_version = context.game.add.text(panel_x + panel_width - 20, 585, "Client v" + bedbugGameCore.game_specs.version, {
            font: '14px Arial',
            fill: '#fff',
            align: 'left'
        })
