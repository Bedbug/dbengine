...
//console.log("Name of Sprite: "+this.normalSprite);
// console.log("Atlas is: "+this.isAtlas);
   this.createStates();
 ...
 if(this.isAtlas === true){ 
  ...
  BBSlot.prototype.createStateWin = function() {
   ...
   if(this.isAtlas === true){ 
     ...
     this.BBSlotAnim.animations.add("win", Phaser.Animation.generateFrameNames( animationName, 0, 19, '.png', 5 ), 16, true);
  ...
  BBSlot.prototype.actionOnClick = function() {
   ...
   if(this.isAtlas === true) {
     ...
     this.BBSlotAnim.animations.play("win", 16, false);
  ...
  BBSlot.prototype.setToWin = function(notToTop) {
   ...
   if(this.isAtlas === true){ 
     this.BBSlotAnimed = this.BBSlotAnim.animations.play("win", 14, false);
   }else{
     this.BBSlotAnimed = this.BBSlotAnim.animations.play(this.Spritesheet, 14, false);
