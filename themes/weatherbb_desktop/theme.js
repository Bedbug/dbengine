Theme = {
    ...
    create: function(context) {
        ...
        // Wind    
        var windBg = context.game.add.sprite(context.game.width / 2, context.game.height / 2, 'extras', 'sun_bg.png');
        windBg.alpha = 1;
        ...
        var houseWind = context.game.add.sprite(260, 210, "extras", "HouseStorm_00000.png");
        houseWind.scale.setTo(-1.8, 1.8);
        houseWind.animations.add("housestorm", Phaser.Animation.generateFrameNames("HouseStorm_", 0, 23, ".png", 5), 16, true);
        houseWind.play("housestorm", 16, true);
        windGroup.add(houseWind);
    ...
    createAnticipationAnimation: function(reelName, x, y) {
        ...
        anticipation.scale.setTo(0, 1.02);
