  ...
  BBSlot.prototype.createStateSpin = function() {
   ...
   this.BBSlotAnim = this.game.add.sprite(0, 0, "glows", "Ankh_Glow_00000.png");
  ...
  BBSlot.prototype.createStateAppear = function() {
   ...
   if (this.type != "Wild") {
    // //  Background;
    this.symbolBg = this.game.add.sprite(0, 0, "symbols2", this.winSprite + "bg.png");
    ...
    this.finalSymbol = this.game.add.sprite(0, 0, "symbols2", this.winSprite + "Bevel.png");
    this.finalSymbol.anchor.setTo(0.5, 0.5);
    this.finalSymbol.visible = false;

    this.AppearGroup.add(this.symbolBg);
    this.AppearGroup.add(this.animatedSymbol);
    this.AppearGroup.add(this.finalSymbol);
   }
   else {
    this.symbolBg = this.game.add.sprite(0, 0, "symbols2", "Cane_bg.png");
    this.symbolBg.anchor.setTo(0.5, 0.5);

    this.animatedSymbol = this.game.add.sprite(0, 0, "symbols2", this.winSprite + ".0001.png"); // Add sprite giving the name and the Atlas
  ...
  BBSlot.prototype.createStateLost = function() {
   ...
   if (this.type != "Wild") {
    this.lostBg = this.game.add.sprite(0, 0, "symbols2", this.winSprite + "bg.png");
    ...
    this.lostBg = this.game.add.sprite(0, 0, "symbols2", "Cane_bg.png");
    this.lostBg.anchor.setTo(0.5, 0.5);
    this.lostBg.alpha = 0.3;
  ...
  BBSlot.prototype.createStateWin = function() {
   ...
   if (this.type != "Wild") {
    this.winBg = this.game.add.sprite(0, 0, "symbols2", this.winSprite + "bg.png");
    this.winBg.anchor.setTo(0.5, 0.5);

    this.winbox = this.game.add.sprite(0, 0, "glows", "winbox_00000.png");
    ...
    this.winSymbol = this.game.add.sprite(0, 0, "glows");
    ...
    this.winBg = this.game.add.sprite(0, 0, "symbols2", "Cane_bg.png");
    this.winBg.anchor.setTo(0.5, 0.5);
    ...
    this.mainSymbol = this.game.add.sprite(0, 0, "symbols2", this.normalSprite);
    this.mainSymbol.anchor.setTo(.5, .5);
    this.winSymbol = this.game.add.sprite(0, 0, "symbols2");
  ...
  BBSlot.prototype.setToBlur = function() {
   ...
   // console.log("blur");
   // this.game.add.tween(this.AppearGroup).to( {alpha: 0 }, 5000, Phaser.Easing.Linear.Out, true);
  }

  BBSlot.prototype.fadeSymbol = function() {
   // this.NormalGroup.visible = false;
   // this.SpinGroup.visible = false;
   // this.AppearGroup.visible = false;
   // this.LostGroup.visible = false;
   ...
   this.game.add.tween(this.AppearGroup).to({
    alpha: 0
   }, alphaSetting.time, alphaSetting.easing, true, alphaSetting.delay);
   this.game.add.tween(this.AppearGroup.scale).to(scaleSetting.scale, this.game.rnd.integerInRange(scaleSetting.time, alphaSetting.time), scaleSetting.easing, true, scaleSetting.delay);

   this.game.add.tween(this.WinGroup).to({
    alpha: 0
   }, alphaSetting.time, alphaSetting.easing, true, alphaSetting.delay);
   this.game.add.tween(this.WinGroup.scale).to(scaleSetting.scale, this.game.rnd.integerInRange(scaleSetting.time, alphaSetting.time), scaleSetting.easing, true, scaleSetting.delay);

   this.game.add.tween(this.LostGroup).to({
    alpha: 0
   }, alphaSetting.time, alphaSetting.easing, true, alphaSetting.delay);
   this.game.add.tween(this.LostGroup.scale).to(scaleSetting.scale, this.game.rnd.integerInRange(scaleSetting.time, alphaSetting.time), scaleSetting.easing, true, scaleSetting.delay);
  }
  ...
  BBSlot.prototype.setToAppear = function() {
   ...
   this.WinGroup.visible = false;
   // // DROP
   var animatedAppear = this.animatedSymbol.animations.play("appear");

   animatedAppear.onComplete.add(function() {
    if (this.finalSymbol)
     this.finalSymbol.visible = true;
   }, this);
