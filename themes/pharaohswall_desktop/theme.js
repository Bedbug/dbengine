Theme = {
    ...
    create: function(context) {
        ...
        var palmRight = context.game.add.sprite(5, -50, "mainSet", 'PalmRight.png');
        palmRight.scale.setTo(1, 1.1);
        var palmRight2 = context.game.add.sprite(1330, 130, "mainSet", 'PalmLeft.png');
        palmRight2.scale.setTo(-1, .8);
        ...
        // Workers
        var worker1 = context.game.add.sprite(0, -35, "extras", 'worker1.0001.png');
        // camel.scale.setTo(.7);
        worker1.animations.add("workAnim", Phaser.Animation.generateFrameNames("worker1.", 1, 46, '.png', 4), 12, true);
        worker1.animations.play("workAnim");

        var worker2 = context.game.add.sprite(1280, -35, "extras", 'worker1.0001.png');
        worker2.scale.setTo(-1, 1);
        worker2.animations.add("workAnim", Phaser.Animation.generateFrameNames("worker1.", 1, 46, '.png', 4), 15, true);
        worker2.animations.play("workAnim");

        var pylons = context.game.add.sprite(-15, -20, "mainSet", 'Pylons.png');
        var rockUi = context.game.add.sprite(context.game.width / 2, 370, "mainSet", 'rockui.png');
        ...
        // this.stoneExplode1 = context.game.add.sprite(0, -35, "extras",'rockExplode.0001.png');
        // this.stoneDrop1 = this.stoneExplode1.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 1, 18, '.png', 4), 24, false);
        ...
        // this.stoneExplode2 = context.game.add.sprite(0, -35, "extras",'rockExplode.0001.png');
        // this.stoneDrop2 = this.stoneExplode2.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 1, 18, '.png', 4), 24, false);
        ...
        this.stoneExplode0 = context.game.add.sprite(-306.73, -160.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode0.alpha = 0.1;
        this.stoneExplodeAnim0 = this.stoneExplode0.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode1 = context.game.add.sprite(-306.73, -23.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode1.alpha = 0.1;
        this.stoneExplodeAnim1 = this.stoneExplode1.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode2 = context.game.add.sprite(-306.73, 114.84, "extras", 'rockExplode.0019.png');
        this.stoneExplode2.alpha = 0.1;
        this.stoneExplodeAnim2 = this.stoneExplode2.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));

        this.stoneExplode3 = context.game.add.sprite(-153, -160.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode3.alpha = 0.1;
        this.stoneExplodeAnim3 = this.stoneExplode3.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode4 = context.game.add.sprite(-153, -23.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode4.alpha = 0.1;
        this.stoneExplodeAnim4 = this.stoneExplode4.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode5 = context.game.add.sprite(-153, 114.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode5.alpha = 0.1;
        this.stoneExplodeAnim5 = this.stoneExplode5.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));

        this.stoneExplode6 = context.game.add.sprite(0, -160.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode6.alpha = 0.1;
        this.stoneExplodeAnim6 = this.stoneExplode6.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode7 = context.game.add.sprite(0, -23.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode7.alpha = 0.1;
        this.stoneExplodeAnim7 = this.stoneExplode7.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode8 = context.game.add.sprite(0, 114.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode8.alpha = 0.1;
        this.stoneExplodeAnim8 = this.stoneExplode8.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));

        this.stoneExplode9 = context.game.add.sprite(153, -160.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode9.alpha = 0.1;
        this.stoneExplodeAnim9 = this.stoneExplode9.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode10 = context.game.add.sprite(153, -23.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode10.alpha = 0.1;
        this.stoneExplodeAnim10 = this.stoneExplode10.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode11 = context.game.add.sprite(153, 114.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode11.alpha = 0.1;
        this.stoneExplodeAnim11 = this.stoneExplode11.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));

        this.stoneExplode12 = context.game.add.sprite(306.73, -160.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode12.alpha = 0.1;
        this.stoneExplodeAnim12 = this.stoneExplode12.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode13 = context.game.add.sprite(306.73, -23.51, "extras", 'rockExplode.0019.png');
        this.stoneExplode13.alpha = 0.1;
        this.stoneExplodeAnim13 = this.stoneExplode13.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));
        this.stoneExplode14 = context.game.add.sprite(306.73, 114.84, "extras", 'rockExplode.0019.png');
        this.stoneExplode14.alpha = 0.1;
        this.stoneExplodeAnim14 = this.stoneExplode14.animations.add("stoneExplode", Phaser.Animation.generateFrameNames("rockExplode.", 0, 19, '.png', 4));

        this.stoneBreak0 = context.game.add.sprite(202, 128, "extras", 'stoneBreak_00029.png');
        this.stoneBreakAnim0 = this.stoneBreak0.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak_", 0, 29, '.png', 5));
        this.stoneBreak1 = context.game.add.sprite(202, 266, "extras", 'stoneBreak2_00029.png');
        this.stoneBreakAnim1 = this.stoneBreak1.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak2_", 0, 29, '.png', 5));
        this.stoneBreak2 = context.game.add.sprite(202, 400, "extras", 'stoneBreak_00029.png');
        this.stoneBreakAnim2 = this.stoneBreak2.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak_", 0, 29, '.png', 5));

        this.stoneBreak3 = context.game.add.sprite(356, 129, "extras", 'stoneBreak2_00029.png');
        this.stoneBreakAnim3 = this.stoneBreak3.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak2_", 0, 29, '.png', 5));
        this.stoneBreak4 = context.game.add.sprite(356, 266, "extras", 'stoneBreak_00029.png');
        this.stoneBreakAnim4 = this.stoneBreak4.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak_", 0, 29, '.png', 5));
        this.stoneBreak5 = context.game.add.sprite(356, 400, "extras", 'stoneBreak2_00029.png');
        this.stoneBreakAnim5 = this.stoneBreak5.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak2_", 0, 29, '.png', 5));

        this.stoneBreak6 = context.game.add.sprite(507, 128, "extras", 'stoneBreak_00029.png');
        this.stoneBreakAnim6 = this.stoneBreak6.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak_", 0, 29, '.png', 5));
        this.stoneBreak7 = context.game.add.sprite(507, 266, "extras", 'stoneBreak2_00029.png');
        this.stoneBreakAnim7 = this.stoneBreak7.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak2_", 0, 29, '.png', 5));
        this.stoneBreak8 = context.game.add.sprite(507, 400, "extras", 'stoneBreak_00029.png');
        this.stoneBreakAnim8 = this.stoneBreak8.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak_", 0, 29, '.png', 5));

        this.stoneBreak9 = context.game.add.sprite(664, 128, "extras", 'stoneBreak2_00029.png');
        this.stoneBreakAnim9 = this.stoneBreak9.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak2_", 0, 29, '.png', 5));
        this.stoneBreak10 = context.game.add.sprite(664, 266, "extras", 'stoneBreak_00029.png');
        this.stoneBreakAnim10 = this.stoneBreak10.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak_", 0, 29, '.png', 5));
        this.stoneBreak11 = context.game.add.sprite(664, 400, "extras", 'stoneBreak2_00029.png');
        this.stoneBreakAnim11 = this.stoneBreak11.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak2_", 0, 29, '.png', 5));

        this.stoneBreak12 = context.game.add.sprite(817, 129, "extras", 'stoneBreak_00029.png');
        this.stoneBreakAnim12 = this.stoneBreak12.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak_", 0, 29, '.png', 5));
        this.stoneBreak13 = context.game.add.sprite(817, 266, "extras", 'stoneBreak2_00029.png');
        this.stoneBreakAnim13 = this.stoneBreak13.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak2_", 0, 29, '.png', 5));
        this.stoneBreak14 = context.game.add.sprite(817, 400, "extras", 'stoneBreak_00029.png');
        this.stoneBreakAnim14 = this.stoneBreak14.animations.add("stoneBreak", Phaser.Animation.generateFrameNames("stoneBreak_", 0, 29, '.png', 5));
        ...
        this.topStoneLift = this.topStone.animations.add("topLift", ['topDrop.0006.png', 'topDrop.0005.png', 'topDrop.0004.png', 'topDrop.0003.png', 'topDrop.0002.png', 'topDrop.0001.png'], 14);
        // TOP STONE DUST
        ...
        this.secstore = context.game.add.sprite(254, 269, "extras", 'secstore.png');
        this.secstore.visible = false;
        this.thirdstore = context.game.add.sprite(255, 407, "extras", 'thirdstore.png');
        this.thirdstore.visible = false;
        ...
        // this.stoneExplodes = [];
        //  this.stoneExplodes.push(this.stoneExplodeAnim0);
        //  this.stoneExplodes.push(this.stoneExplodeAnim1);
        //  this.stoneExplodes.push(this.stoneExplodeAnim2);
        //  this.stoneExplodes.push(this.stoneExplodeAnim3);
        //  this.stoneExplodes.push(this.stoneExplodeAnim4);
        //  this.stoneExplodes.push(this.stoneExplodeAnim5);
        //  this.stoneExplodes.push(this.stoneExplodeAnim6);
        //  this.stoneExplodes.push(this.stoneExplodeAnim7);
        //  this.stoneExplodes.push(this.stoneExplodeAnim8);
        //  this.stoneExplodes.push(this.stoneExplodeAnim9);
        //  this.stoneExplodes.push(this.stoneExplodeAnim10);
        //  this.stoneExplodes.push(this.stoneExplodeAnim11);
        //  this.stoneExplodes.push(this.stoneExplodeAnim12);
        //  this.stoneExplodes.push(this.stoneExplodeAnim13);
        //  this.stoneExplodes.push(this.stoneExplodeAnim14);
        ...
        this.stoneBreaks = [];
        this.stoneBreaks.push(this.stoneBreakAnim0);
        this.stoneBreaks.push(this.stoneBreakAnim3);
        this.stoneBreaks.push(this.stoneBreakAnim6);
        this.stoneBreaks.push(this.stoneBreakAnim9);
        this.stoneBreaks.push(this.stoneBreakAnim12);
        this.stoneBreaks.push(this.stoneBreakAnim1);
        this.stoneBreaks.push(this.stoneBreakAnim4);
        this.stoneBreaks.push(this.stoneBreakAnim7);
        this.stoneBreaks.push(this.stoneBreakAnim10);
        this.stoneBreaks.push(this.stoneBreakAnim13);
        this.stoneBreaks.push(this.stoneBreakAnim2);
        this.stoneBreaks.push(this.stoneBreakAnim5);
        this.stoneBreaks.push(this.stoneBreakAnim8);
        this.stoneBreaks.push(this.stoneBreakAnim11);
        this.stoneBreaks.push(this.stoneBreakAnim14);

        this.stonesDroping = false;
        this.stoneCount = 0;

        this.playStoneAnim = function(stoneAnim, stoneCount) {
            // this.stones[this.stoneCount-1].setFrame(10);
            ...
            if (stoneAnim) {
                stoneAnim.play(context.game.rnd.integerInRange(55, 60), false);
                this.stoneCount++;
                // console.log("StoneCount: ",this.stoneCount);
                ...
                stoneAnim.onComplete.add(function() {
                    ...
                    // Request stone drop sound
                    bedbugEventsSystem.emitEvent('ON_STONE_DROP')
                    // console.log("StoneAnim END: ",stoneAnim);
                    // Goto To Last Frame
                    // console.log(stoneAnim.currentFrame);
                    // // this.stoneSprites[stoneCount].framename = "rockDrop.0001.png";
                    // // this.stones[stoneCount].framename = "rockDrop.0001.png";
                    if(stoneCount == 1) this.stone1.frameName =  "rockDrop.0010.png";
                    if(stoneCount == 2) this.stone2.frameName =  "rockDrop.0020.png";
                    if(stoneCount == 3) this.stone3.frameName =  "rockDrop.0030.png";
                    if(stoneCount == 4) this.stone4.frameName =  "rockDrop.0040.png";
                    if(stoneCount == 5) this.stone5.frameName =  "rockDrop.0050.png";
                    if(stoneCount == 6) this.stone6.frameName =  "rockDrop.0060.png";
                    if(stoneCount == 7) this.stone7.frameName =  "rockDrop.0070.png";
                    if(stoneCount == 8) this.stone8.frameName =  "rockDrop.0080.png";
                    if(stoneCount == 9) this.stone9.frameName =  "rockDrop.0090.png";
                    if(stoneCount == 10) this.stone10.frameName =  "rockDrop.0100.png";
                    if(stoneCount == 11) this.stone11.frameName =  "rockDrop.0110.png";
                    if(stoneCount == 12) this.stone12.frameName =  "rockDrop.0120.png";
                    if(stoneCount == 13) this.stone13.frameName =  "rockDrop.0130.png";
                    if(stoneCount == 14) this.stone14.frameName =  "rockDrop.0140.png";
                    if(stoneCount == 15) this.stone15.frameName =  "rockDrop.0150.png";
                    // this.stoneSprites[stoneCount].framename = "rockDrop.0028.png"
                    // console.log("Stone Count: ",stoneCount)
                    // console.log(this.stoneSprites[stoneCount].framename)
                    // console.log(this.stone1);
                    // this.stone1.frameName =  "rockDrop.0028.png";
                    // this.stoneSprites[stoneCount].framename = "rockDrop.0028.png";
                    
                    // stoneAnim.currentFrame.name = "rockDrop.0028.png"
                    // console.log(stoneAnim.frameData);
        ...
        this.lensFlare.scale.setTo(2.1);
        this.lensFlare.alpha = .7;
        ...
        //thirdstore.inputEnabled = true;
        //thirdstore.input.enableDrag();
        //thirdstore.events.onDragStop.add(onDragStop, this);
    ...
    playPointsTween: function(context, pointsLabel) {
        context.game.add.tween(pointsLabel).from({
            alpha: 0
        }, 200, Phaser.Easing.Linear.none, true, 200);
        
        context.game.add.tween(pointsLabel.scale).from({
            y: 2.0,
            x: 2.0
        }, Theme.values.pointTweenSpeed, Phaser.Easing.Elastic.Out, true, 300);
    },
    playSmallEffect: function(context) {
        // Request small win sound
        bedbugEventsSystem.emitEvent('ON_POINTS_WIN')
    },
    ...
    stoneDisolve: function(that) {
        this.topStoneLift.play();
        // for(var j = 0; j < this.stoneExplodes.length; j++) {

        //       this.stoneExplodes[j].play( that.game.rnd.integerInRange(30, 50));
        //         // this.stoneSprites[i].visible = false;
        //     }
        this.secstore.visible = true;
        this.secstore.alpha = 1;
        this.thirdstore.visible = true;
        this.thirdstore.alpha = 1;
        ...
        for (var j = 0; j < 5; j++) {
            this.stoneBreaks[j].play(that.game.rnd.integerInRange(50, 60));
             this.stoneExplodes[j].play( that.game.rnd.integerInRange(20, 30));
        }

        that.game.time.events.add(Phaser.Timer.SECOND * 0.25, function() {
            this.lensFlare.visible = true;
            //this.secstore.visible = false;
            that.game.add.tween(this.secstore).to({
                alpha: 0.0
        ...
        that.game.time.events.add(Phaser.Timer.SECOND * 0.50, function() {

            that.game.add.tween(this.thirdstore).to({
                alpha: 0.0
            }, 300, Phaser.Easing.Exponential.InOut, true);
    ...
    stoneDropAnimation: function(that) {
        // console.log("STONE DROPP CALLED!!!!!!!");
        // this.stoneExplodeAnim0.play("stoneExplode");
        // Explode the stones
        // var temptime = that.game.rnd.integerInRange(50, 60);;
    ...
    createLine: function(line, slim, lineContext, context) {
        ...
        // WinBoxes
        // var winboxes = [];
        var winbox1 = context.game.add.sprite(0, 0, "glows", "winbox_00000.png");
        ...
        var winbox2 = context.game.add.sprite(0, 0, "glows", "winbox_00000.png");
        ...
        var winbox3 = context.game.add.sprite(0, 0, "glows", "winbox_00000.png");
        ...
        var winbox4 = context.game.add.sprite(0, 0, "glows", "winbox_00000.png");
        ...
        var winbox5 = context.game.add.sprite(0, 0, "glows", "winbox_00000.png");
        ...
        _.forEach(line.slots, function(row) {
            ...
            if (reelPoint == 3) {
                ...
                lineContext.PointsLabel.letterSpacing = 50;
                lineContext.PointsLabel.anchor.setTo(0.5, 0.5);
                 bedbugGameCore.WinningLayerGroup.add(lineContext.PointsLabel);
