        ...
        _.times(results.length, function(i) {
            ...
            if (bedbugGameCore.Slots[results[k]]) {
                ...
                setTimeout(function() {
                    ...
                    Timmings.symbol_stagger_start_delay * k
                );
        ...
        setTimeout(function() {
            ...
            if (ReelPlayType == REEL_TYPES.NORMAL || ReelPlayType == REEL_TYPES.NORMAL_SCATTER) {
                ...
                _.each(that.Slots, function(slot) {
                    ...
                    }, Timmings.symbol_stagger_end_delay * ind);
                    ind--;
                ...
                }, Timmings.symbol_stagger_end_delay * results.length - 1);
            }
            /**
             ...
             */
                ...
                var AnticipationEnd = setTimeout(function() {
                    ...
                    bedbugEventsSystem.emitEvent('ON_REEL_BOUNCE');
                }, bedbugGameCore.settings.fast_spins ? Timmings.fast_spin_anticipation_time * anticipationIndex : Timmings.anticipation_time * anticipationIndex);
            }
        }, spinTime)
