Controls = {
    create: function(context) {
        ...
        // });
        this.balance_label_heading = context.game.add.text(550, 24, bedbugGameCore.getLocalizedText("TXT_BALANCE_LABEL"), {
            font: "17px Arial",
            fill: "#EAEAEA"
        });
        ...
        // Bet
        this.bet_heading = context.game.add.text(720, 24, bedbugGameCore.getLocalizedText("TXT_BET_LABEL"), {
            font: "17px Arial",
            fill: "#EAEAEA"
        ...
        this.win_label_heading = context.game.add.text(860, 24, bedbugGameCore.getLocalizedText("TXT_WIN_LABEL"), {
            font: "17px Arial",
            fill: "#EAEAEA",
        });
        ...
        this.game_time = context.game.add.text(1070, 24, "", {
            font: "17px Arial",
            fill: "#EAEAEA",
        });
    ...
    createPaytable: function(context) {
        ...
        // WILD SYMBOL
        var wildsymbol = getSymbol(bedbugGameCore.symbolNameToID("WILD"), (panel_width) - 120, 160, 130);
        var wildText = context.game.add.text(wildsymbol.x, wildsymbol.y + 120, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_06") + "\n" + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_07"), {
            'font': ' 22px Arial',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        // SCATTER SYMBOL
        var scattersymbol = getSymbol(bedbugGameCore.symbolNameToID("SCAT"), left + 80, 170, 130, "80 + 20 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"), "35 + 15 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"), "15 + 10 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"));

        var scatterText = context.game.add.text(left, scattersymbol.y + 90, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_01"), {
            'font': ' 22px Arial',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        var symbol1 = getSymbol(bedbugGameCore.symbolNameToID("P4"), left + 40, 200, 130, getAward("P4", "5"), getAward("P4", "4"), getAward("P4", "3"));
        var symbol2 = getSymbol(bedbugGameCore.symbolNameToID("P3"), left + 260, 200, 130, getAward("P3", "5"), getAward("P3", "4"), getAward("P3", "3"));
        var symbol3 = getSymbol(bedbugGameCore.symbolNameToID("P2"), left + 470, 200, 130, getAward("P2", "5"), getAward("P2", "4"), getAward("P2", "3"));
        var symbol4 = getSymbol(bedbugGameCore.symbolNameToID("P1"), left + 690, 200, 130, getAward("P1", "5"), getAward("P1", "4"), getAward("P1", "3"));
        // var symbol5 = getSymbol(bedbugGameCore.symbolNameToID("M1"), left + 615, 390, 130, 250, 40, 20);
        var symbol7 = getSymbol(bedbugGameCore.symbolNameToID("L4"), left + 40, 380, 130, getAward("L4", "5"), getAward("L4", "4"), getAward("L4", "3"));
        var symbol8 = getSymbol(bedbugGameCore.symbolNameToID("L3"), left + 260, 380, 130, getAward("L3", "5"), getAward("L3", "4"), getAward("L3", "3"));
        var symbol9 = getSymbol(bedbugGameCore.symbolNameToID("L2"), left + 470, 380, 130, getAward("L2", "5"), getAward("L2", "4"), getAward("L2", "3"));
        var symbol10 = getSymbol(bedbugGameCore.symbolNameToID("L1"), left + 690, 380, 130, getAward("L1", "5"), getAward("L1", "4"), getAward("L1", "3"));
