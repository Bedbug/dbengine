Controls = {
    create: function(context) {
        ...
        // Play Button
        this.play_button = context.game.add.button(645, 665, 'assets', context.play_spin, context, 'SPIN_OVER.png', 'SPIN_active.png', 'SPIN_pressed.png', 'SPIN_active.png');
        ...
        this.play_button_off = context.game.add.sprite(645, 665, 'assets');
        this.play_button_off.frameName = "SPIN_off.png";
        this.play_button_off.anchor.setTo(.5, .5);
        this.play_button_off.visible = false;
        this.buttonsOffArray.push(this.play_button_off);

        this.countplay_button_stop = context.game.add.button(645, 665, "assets2", context.stop_spin, context, 'STOP_OVER.png', 'STOP_active.png', 'STOP_pressed.png', 'STOP_active.png');
        ...
        this.autoplay_button = context.game.add.button((context.game.width / 2) - 127, 648, 'assets', this.openAutoplayPanel, context, 'AUTOPLAY_OVER.png', 'AUTOPLAY_active.png', 'AUTOPLAY_off.png', 'AUTOPLAY_active.png');
        this.autoplay_button.anchor.setTo(0.5, 0.5);
        this.autoplay_text = context.game.add.text((context.game.width / 2) - 146, 648, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_LABEL"), buttonTextStyle);
        ...
        this.autoplayOff_button = context.game.add.button((context.game.width / 2) - 127, 648, 'assets');
        this.autoplayOff_button.frameName = "AUTOPLAY_off.png";
        this.autoplayOff_button.anchor.setTo(0.5, 0.5);
        this.autoplayOff_text = context.game.add.text((context.game.width / 2) - 146, 648, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_LABEL"), buttonTextStyle);
        ...
        this.auto_stopcount_text = context.game.add.text(45, -3, "0", {
        ...
        this.autoplay_stop_button = context.game.add.button((context.game.width / 2) - 127, 648, 'assets', context.controls_stop_auto, context, 'AUTOPLAY_OVER.png', 'AUTOPLAY_active.png', 'AUTOPLAY_off.png', 'AUTOPLAY_active.png');
        this.autoplay_button.anchor.setTo(0.5, 0.5);
        ...
        this.paytable_button = context.game.add.button((context.game.width / 2) - 127, 681, 'assets', context.showPayTable, context, 'PAYTABLE_OVER.png', 'PAYTABLE_active.png', 'PAYTABLE_off.png', 'PAYTABLE_active.png');
        this.paytable_button.anchor.setTo(0.5, 0.5);

        this.paytable_text = context.game.add.text((context.game.width / 2) - 127, 663, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_LABEL"), buttonTextStyle);
        ...
        this.paytableOff_button = context.game.add.button((context.game.width / 2) - 127, 681, 'assets');
        this.paytableOff_button.frameName = "PAYTABLE_off.png";
        this.paytableOff_button.anchor.setTo(0.5, 0.5);

        this.paytableOff_text = context.game.add.text((context.game.width / 2) - 127, 663, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_LABEL"), buttonTextStyle);
        ...
        this.max_bet_button = context.game.add.button((context.game.width / 2) + 135, 663, 'assets', context.setMaxBet, context, 'MAXBET_OVER.png', 'MAXBET_active.png', 'MAXBET_off.png', 'MAXBET_active.png');
        this.max_bet_button.anchor.setTo(0.5, 0.5);

        this.maxbet_text = context.game.add.text(0, 0, bedbugGameCore.getLocalizedText('TXT_MAX_BET_LABEL'), maxBetStyle);
        ...
        this.max_betOff_button = context.game.add.button((context.game.width / 2) + 135, 663, 'assets');
        this.max_betOff_button.frameName = "MAXBET_off.png";
        this.max_betOff_button.anchor.setTo(0.5, 0.5);

        this.maxbetOff_text = context.game.add.text(0, 0, bedbugGameCore.getLocalizedText('TXT_MAX_BET_LABEL'), maxBetStyle);
        ...
        this.decr_level_button = context.game.add.button(202, 673, 'assets', bedbugGameCore.decrBetLevel, this, 'Arrow-decrease_coin_over.png', 'Arrow-decrease_coin_active.png', 'Arrow-decrease_coins_off.png', 'Arrow-decrease_coin_active.png');
        this.decr_level_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.decr_level_button);

        this.decr_levelOff_button = context.game.add.button(202, 673, 'assets');
        this.decr_levelOff_button.frameName = "Arrow-decrease_coins_off.png";
        ...
        this.incr_level_button = context.game.add.button(284, 673, 'assets', bedbugGameCore.incrBetLevel, this, 'Arrow-increase_coin_over.png', 'Arrow-increase_coin_active.png', 'Arrow-increase_coins_off.png', 'Arrow-increase_coin_active.png');
        this.incr_level_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.incr_level_button);

        this.incr_levelOff_button = context.game.add.button(284, 673, 'assets');
        this.incr_levelOff_button.frameName = "Arrow-increase_coins_off.png";
        this.incr_levelOff_button.anchor.setTo(0.5, 0.5);
        this.buttonsOffArray.push(this.incr_levelOff_button);


        this.decr_coin_value_button = context.game.add.button(1000, 669, 'assets', bedbugGameCore.decrCoinValue, this, 'Arrow-decrease_coin_over.png', 'Arrow-decrease_coin_active.png', 'Arrow-decrease_coins_off.png', 'Arrow-decrease_coin_active.png');
        this.decr_coin_value_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.decr_coin_value_button);

        this.decr_coin_valueOff_button = context.game.add.button(1000, 669, 'assets');
        this.decr_coin_valueOff_button.frameName = "Arrow-decrease_coins_off.png";
        this.decr_coin_valueOff_button.anchor.setTo(0.5, 0.5);
        this.buttonsOffArray.push(this.decr_coin_valueOff_button);


        this.incr_coin_value_button = context.game.add.button(1080, 669, 'assets', bedbugGameCore.incrCoinValue, this, 'Arrow-increase_coin_over.png', 'Arrow-increase_coin_active.png', 'Arrow-increase_coins_off.png', 'Arrow-increase_coin_active.png');
        this.incr_coin_value_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.incr_coin_value_button);

        this.incr_coin_valueOff_button = context.game.add.button(1080, 669, 'assets');
        this.incr_coin_valueOff_button.frameName = "Arrow-increase_coins_off.png";
        ...
        this.autoplay_label = new CustomLabel(context.game, bedbugGameCore.autoplay_count, 45, -5, 30, 25);
        this.autoplay_Stop_label = new CustomLabel(context.game, bedbugGameCore.autoplay_count, 45, -5, 30, 25);

        this.coins_label = new CustomLabel(context.game, "500000", -63, 8, 100, 40);
        this.coin_value_label = new CustomLabel(context.game, "0.01", 63, 8, 46, 40);
        this.bet_level_label = new CustomLabel(context.game, "0.01", -63, 8, 46, 40);
        ...
        this.betlevel_heading = context.game.add.text(245, 617, bedbugGameCore.getLocalizedText('TXT_BET_LEVEL_LABEL'), titleStyle);
        this.betlevel_heading.anchor.setTo(0.5, 0);
        this.betlevel_heading.resolution = 2;

        this.bet_heading = context.game.add.text(370, 617, bedbugGameCore.getLocalizedText("TXT_BET_LABEL"), titleStyle);
        this.bet_heading.anchor.setTo(0.5, 0);
        this.bet_heading.resolution = 2;

        this.coins_heading = context.game.add.text(914, 613, bedbugGameCore.getLocalizedText("TXT_COINS_LABEL"), titleStyle);
        this.coins_heading.anchor.setTo(0.5, 0);
        this.coins_heading.resolution = 2;

        this.coin_value_heading = context.game.add.text(1038, 613, bedbugGameCore.getLocalizedText("TXT_COIN_VALUE_LABEL"), titleStyle);
    ...
    createAutoplayPanel: function(context) {
        ...
        this.autoplay_Panel_Bg = bedbugGameCore.game.add.sprite(176, 23, "assets2", "Autoplay_panel.png");
        ...
        this.autoplay_Panel_Bg2 = bedbugGameCore.game.add.sprite(-15, -10, "assets", "Autoplay_panel_second.png");
        this.autoplay_Panel_Bg2.scale.setTo(1, 1.1);
        ...
        this.autoplay_stepper = new StepperSmall(context.game, null, bedbugGameCore.autoplay_count, context.decrAutoplayCount, context.incrAutoplayCount, (width / 2) + 2, 75, 50, 130, true, {
                font: "bold 20px Arial",
                fill: "#FFF",
                heading: {
                    fill: "#FFF"
            ...
            true, "assets", "TextBox_Small.png", "arrow"
        );
        ...
        // Title
        this.title_text = context.game.add.text(252, 42, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_LABEL"), buttonTextStyle);
        ...
        this.advancedOptions = context.game.add.button(250, 115, 'assets', openAutoplayPanel2, this, 'advanced_options_over.png', 'advanced_options_active.png', 'advanced_options_pressed.png', 'advanced_options_active.png');
        this.advancedOptions.anchor.setTo(0.5, 0.5);
        this.advanced_text = context.game.add.text(250, 118, bedbugGameCore.getLocalizedText("TXT_ADVANCED_OPTIONS"), titleStyle);
        ...
        this.startAuto = context.game.add.button(250, 148, 'assets', startAutoplayPanel, this, 'advanced_options_over.png', 'advanced_options_active.png', 'advanced_options_pressed.png', 'advanced_options_active.png');
        this.startAuto.anchor.setTo(0.5, 0.5);
        this.startAuto_text = context.game.add.text(250, 151, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_START_LABEL"), titleStyle);
        ...
        // STOP AT ANY WIN
        this.stop_any_checkbox = new CheckΒoxSmall(0, 10, context.game, null, null, bedbugGameCore.autoplay_setup.on_win.checked, options, function(o) {
            bedbugGameCore.autoplay_setup.on_win.checked = o
        });
        this.stop_any_text = context.game.add.text(25, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_ANY"), titleStyle2);
        ...
        // STOP AT WIN AMOUNT
        this.stop_win_amount = new CheckΒoxSmall(0, 35, context.game, null, bedbugGameCore.autoplay_setup.on_win_amount.value, bedbugGameCore.autoplay_setup.on_win_amount.checked, options, function(o, e) {
            bedbugGameCore.autoplay_setup.on_win_amount.checked = o;
            if (e)
                bedbugGameCore.autoplay_setup.on_win_amount.value = e;
        });
        this.stop_win_text = context.game.add.text(25, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_WIN_AMOUNT"), titleStyle2);
        ...
        // STOP AT CASH
        this.stop_cash_amount = new CheckΒoxSmall(0, 60, context.game, null, bedbugGameCore.autoplay_setup.on_cash_amount.value, bedbugGameCore.autoplay_setup.on_cash_amount.checked, options, function(o, e) {
            bedbugGameCore.autoplay_setup.on_cash_amount.checked = o;
            if (e) bedbugGameCore.autoplay_setup.on_cash_amount.value = e
        });
        this.stop_cash_text = context.game.add.text(25, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_WIN_CASH"), titleStyle2);
        ...
        // STOP AT TIME
        this.stop_time = new CheckΒoxSmall(0, 85, context.game, null, bedbugGameCore.autoplay_setup.on_time.value, bedbugGameCore.autoplay_setup.on_time.checked, options, function(o, e, m) {
            bedbugGameCore.autoplay_setup.on_time.checked = o;
            if (e && m) bedbugGameCore.autoplay_setup.on_time.value = [e, m];
        });
        this.stop_time_text = context.game.add.text(25, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_TIME"), titleStyle2);
        ...
        // STOP AT LOSE
        this.stop_lose = new CheckΒoxSmall(0, 110, context.game, null, bedbugGameCore.autoplay_setup.on_lose.value, bedbugGameCore.autoplay_setup.on_lose.checked, options, function(o, e) {
            bedbugGameCore.autoplay_setup.on_lose.checked = o;
            if (e) bedbugGameCore.autoplay_setup.on_lose.value = e;
        });
        this.stop_lose_text = context.game.add.text(25, -2, bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_LOSE"), titleStyle2);
    ...
    createPopupBG: function(game, width, height, shouldCloseExternalClick, style, onClickOutsideCallback, scope) {
        ...
        var panel_background = game.add.sprite(bedbugGameCore.game.width / 2, bedbugGameCore.game.height / 2, "screens", "Paytable_Clear.png");
    ...
    createPaytable: function(context) {
        ...
        // WILD SYMBOL
        var wildsymbol = getSymbol(bedbugGameCore.symbolNameToID("WILD"), (panel_width) - 120, 140, 130);
        var wildText = context.game.add.text(wildsymbol.x, wildsymbol.y + 130, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_06") + "\n" + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_07"), {
            'font': ' 22px Arial',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        // SCATTER SYMBOL
        var scattersymbol = getSymbol(bedbugGameCore.symbolNameToID("SCAT"), left + 130, 160, 130, "80 + 20 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"), "35 + 15 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"), "15 + 10 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"));

        var scatterText = context.game.add.text(left, scattersymbol.y + 100, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_01"), {
            'font': ' 22px Arial',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        var symbol1 = getSymbol(bedbugGameCore.symbolNameToID("P4"), left + 50, 200, 130, getAward("P4", "5"), getAward("P4", "4"), getAward("P4", "3"));
        var symbol2 = getSymbol(bedbugGameCore.symbolNameToID("P3"), left + 270, 200, 130, getAward("P3", "5"), getAward("P3", "4"), getAward("P3", "3"));
        var symbol3 = getSymbol(bedbugGameCore.symbolNameToID("P2"), left + 480, 200, 130, getAward("P2", "5"), getAward("P2", "4"), getAward("P2", "3"));
        var symbol4 = getSymbol(bedbugGameCore.symbolNameToID("P1"), left + 700, 200, 130, getAward("P1", "5"), getAward("P1", "4"), getAward("P1", "3"));
        // var symbol5 = getSymbol(bedbugGameCore.symbolNameToID("M1"), left + 615, 390, 130, 250, 40, 20);
        var symbol7 = getSymbol(bedbugGameCore.symbolNameToID("L4"), left + 50, 380, 130, getAward("L4", "5"), getAward("L4", "4"), getAward("L4", "3"));
        var symbol8 = getSymbol(bedbugGameCore.symbolNameToID("L3"), left + 270, 380, 130, getAward("L3", "5"), getAward("L3", "4"), getAward("L3", "3"));
        var symbol9 = getSymbol(bedbugGameCore.symbolNameToID("L2"), left + 480, 380, 130, getAward("L2", "5"), getAward("L2", "4"), getAward("L2", "3"));
        var symbol10 = getSymbol(bedbugGameCore.symbolNameToID("L1"), left + 700, 380, 130, getAward("L1", "5"), getAward("L1", "4"), getAward("L1", "3"));
        ...
        // CLOSE BUTTON
        var close_button = bedbugGameCore.game.add.button(panel_width / 2, panel_y + panel_height - 30, 'mobile', hidePaytable, this, 'btn_close_pressed.png', 'btn_close_pressed.png', 'btn_close_active.png');
        ...
        this.close_button2 = bedbugGameCore.game.add.button(645, 595, 'assets', hidePaytable, this, 'advanced_options_over.png', 'advanced_options_active.png', 'advanced_options_pressed.png', 'advanced_options_active.png');
        ...
        this.continue_text = context.game.add.text(0, 5, bedbugGameCore.getLocalizedText('CONTINUE_LABEL'), TextStyle);
        ...
        this.close_button2.addChild(this.continue_text)
        ...
        chevronRight = bedbugGameCore.game.add.button(50, 0, 'assets', chevronRightPress, this, 'arrow_right_over.png', 'arrow_right_active.png', 'arrow_right_pressed.png');
        ...
        chevronLeft = bedbugGameCore.game.add.button(50, 0, 'assets', chevronLeftPress, this, 'arrow_left_over.png', 'arrow_left_active.png', 'arrow_left_pressed.png');
        ...
        context.page_bullets.y = close_button.y - 30;
        ...
        context.drawBullets = function(index) {
            ...
            _.times(context.panel_pages, function(i) {
                var bullets = bedbugGameCore.game.add.sprite(0, 0, "screens");
                if (i == index) {

                    bullets.frameName = "bulletFull.png";
                }
                else {

                    bullets.frameName = "bulletEmpty.png";
                }
