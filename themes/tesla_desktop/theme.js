Theme = {
    ...
    create: function(context) {
        ...
        var game_background = context.game.add.sprite(0, 0, 'game_background');
        ...
        this.openEngines = function() {
            ...
            this.leftEngineStart = context.game.add.tween(this.engineLeft).from({
                alpha: 0
            }, 300, "Elastic.easeOut", true, 0, 0, false);
            this.rightEngineStart = context.game.add.tween(this.engineRight).from({
                alpha: 0
            }, 300, "Elastic.easeOut", true, 0, 0, false);
            ...
            setTimeout(function() {
                ...
                scope.leftEngineAnim = context.game.add.tween(scope.engineLeft).from({
                    alpha: 1
                }, 750, Phaser.Easing.Linear.None, true, 0, 1000, true);
                scope.leftEngineAnim.yoyo(true, 200);

                scope.rightEngineAnim = context.game.add.tween(scope.engineRight).from({
                    alpha: 1
                }, 750, Phaser.Easing.Linear.None, true, 0, 1000, true);
        ...
        // context.winGroup.add( bedbugGameCore.bigwinLabel_text);
    ...
    createAnticipationAnimation: function(reelName, x, y, ReelPlayType) {
        ...
        anticipationGroup.x = x;
        anticipationGroup.y = y;
    ...
    updateBonusInfo: function(totalwin, freespins, context) {
        if (context.infotextarea) {
            context.infotextarea.setText("                    " + bedbugGameCore.getLocalizedText("TXT_TOTAL_WIN").replace("$(1)", " ") + totalwin);
            context.infotextarea2.setText(bedbugGameCore.getLocalizedText("TXT_FREESPINS_LEFT").replace("$(1)", " ") + freespins);
        }
    },
    /*********************************************************************************************
     *  End Bonus Game
    ...
    endBonusGame: function(context) {
        ...
        // Update the Text
        // this.freespins_text.setText( "You Won\n"+ bedbugGameCore.bonus_total_coins +" coins");
        ...
        this.freespins_text.wordWrap = true;
        this.freespins_text.wordWrapWidth = 200;
        //context.game.bringToTop(this.spinsGroup);
