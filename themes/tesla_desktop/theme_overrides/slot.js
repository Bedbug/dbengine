  ...
  BBSlot.prototype.createStates = function() {
   ...
   // this.AppearGroup.inputEnableChildren = true;
   // this.AppearGroup.onChildInputDown.add(showSymbolInfo, this);
   ...
   bg_graphic.drawRoundedRect(0, 0, 100, 100, 6);
  ...
  BBSlot.prototype.createStateNormal = function() {
   ...
   var timeToTween = this.game.rnd.integerInRange(5000, 35000);
  ...
  BBSlot.prototype.actionOnClick = function() {
   ...
   setTimeout(function() {
    if (that.animatedSymbol.frameName == "Symbol_Special_PLAY_PlasmaBall.png") {
     that.SpinGroup.visible = false;
     that.AppearGroup.visible = false;
     that.NormalGroup.visible = false;
     that.LostGroup.visible = false;
     // this.BlurGroup.visible = false;
     that.WinGroup.visible = true;

     that.scatterAppear = that.BBSlotWinAnim.animations.play("win", 40, false);
     that.scatterAppear.onComplete.add(function() {
      if (!that.LostGroup.visible) {
       that.AppearGroup.visible = true;
       that.WinGroup.visible = false;
      }
      // this.NormalGroup.visible = false;
      // this.SpinGroup.visible = false;
  ...
  BBSlot.prototype.setToAppear = function() {
   ...
   this.WinGroup.visible = false;
   // DROP
   this.symbolAppear = bedbugGameCore.game.add.tween(this.animatedSymbol).from({
    y: -200
