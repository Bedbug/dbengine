Controls = {
    create: function(context) {
        ...
        // Play Button
        this.play_button = context.game.add.button(640, 659, 'assets', context.play_spin, context, 'button-spin-over.png', 'button-spin-active.png', 'button-spin-pressed-anim01.png', 'button-spin-active.png');
        ...
        this.countplay_button_stop = context.game.add.button(640, 659, "assets", context.stop_spin, context, 'button-spin-over.png', 'button-spin-active.png', 'button-spin-pressed-anim01.png', 'button-spin-active.png');
        this.countplay_button_stop.anchor.setTo(.5, .5);

        this.animatedSpin = context.game.add.sprite(640, 659, 'assets', "button-spin-pressed-anim01.png");
        this.animatedSpin.anchor.setTo(.5, .5);
        this.animatedSpin.animations.add("spin", Phaser.Animation.generateFrameNames("button-spin-pressed-anim", 1, 12, '.png', 2), 24, false);
        ...
        this.autoplay_button = context.game.add.button((context.game.width / 2) - 140, 649, 'assets', this.openAutoplayPanel, context, 'button-autoplay-over.png', 'button-autoplay-active.png', 'button-autoplay-pressed.png', 'button-autoplay-active.png');
        ...
        this.autoplayOff_button = context.game.add.button((context.game.width / 2) - 140, 649, 'assets');
        ...
        this.auto_stopcount_text = context.game.add.text(57, 2, "0", {
        ...
        this.autoplay_stop_button = context.game.add.button((context.game.width / 2) - 140, 649, 'assets', context.controls_stop_auto, context, 'button-autoplay-over.png', 'button-autoplay-active.png', 'button-autoplay-pressed.png', 'button-autoplay-active.png');
        this.autoplay_button.anchor.setTo(0.5, 0.5);
        this.autoplay_stop_button.anchor.setTo(0.5, 0.5);
        this.autoplay_stop_text = context.game.add.bitmapText(-19, 0, "contrail_small", bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_LABEL"), 20);
        ...
        this.paytable_button = context.game.add.button((context.game.width / 2) - 140, 684, 'assets', context.showPayTable, context, 'button-paytable-over.png', 'button-paytable-active.png', 'button-paytable-pressed.png', 'button-paytable-active.png');
        ...
        this.paytableOff_button = context.game.add.button((context.game.width / 2) - 140, 684, 'assets');
        ...
        this.max_bet_button = context.game.add.button((context.game.width / 2) + 140, 666, 'assets', context.setMaxBet, context, 'button-max-bet-over.png', 'button-max-bet-active.png', 'button-max-bet-pressed.png', 'button-max-bet-active.png');
        this.max_bet_button.anchor.setTo(0.5, 0.5);
        this.maxbet_text = context.game.add.bitmapText(0, 3, "contrail_small", bedbugGameCore.getLocalizedText('TXT_MAX_BET_LABEL'), 30);
        ...
        this.max_betOff_button = context.game.add.button((context.game.width / 2) + 140, 666, 'assets');
        this.max_betOff_button.frameName = "button-max-bet-inactive.png";
        this.max_betOff_button.anchor.setTo(0.5, 0.5);
        this.maxbetOff_text = context.game.add.bitmapText(0, 3, "contrail_small", bedbugGameCore.getLocalizedText('TXT_MAX_BET_LABEL'), 30);
        ...
        this.decr_level_button = context.game.add.button(165, 683, 'assets', bedbugGameCore.decrBetLevel, this, 'button-arrow-minus-over.png', 'button-arrow-minus-active.png', 'button-arrow-minus-pressed.png', 'button-arrow-minus-active.png');
        this.decr_level_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.decr_level_button);

        this.decr_levelOff_button = context.game.add.button(165, 683, 'assets');
        ...
        this.incr_level_button = context.game.add.button(261, 683, 'assets', bedbugGameCore.incrBetLevel, this, 'button-arrow-add-over.png', 'button-arrow-add-active.png', 'button-arrow-add-pressed.png', 'button-arrow-add-active.png');
        this.incr_level_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.incr_level_button);

        this.incr_levelOff_button = context.game.add.button(261, 683, 'assets');
        this.incr_levelOff_button.frameName = "button-arrow-add-inactive.png";
        this.incr_levelOff_button.anchor.setTo(0.5, 0.5);
        this.buttonsOffArray.push(this.incr_levelOff_button);


        this.decr_coin_value_button = context.game.add.button(1020, 683, 'assets', bedbugGameCore.decrCoinValue, this, 'button-arrow-minus-over.png', 'button-arrow-minus-active.png', 'button-arrow-minus-pressed.png', 'button-arrow-minus-active.png');
        this.decr_coin_value_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.decr_coin_value_button);

        this.decr_coin_valueOff_button = context.game.add.button(1020, 683, 'assets');
        ...
        this.incr_coin_value_button = context.game.add.button(1116, 683, 'assets', bedbugGameCore.incrCoinValue, this, 'button-arrow-add-over.png', 'button-arrow-add-active.png', 'button-arrow-add-pressed.png', 'button-arrow-add-active.png');
        this.incr_coin_value_button.anchor.setTo(0.5, 0.5);
        this.buttonArray.push(this.incr_coin_value_button);

        this.incr_coin_valueOff_button = context.game.add.button(1116, 683, 'assets');
        this.incr_coin_valueOff_button.frameName = "button-arrow-add-inactive.png";
        ...
        this.autoplay_label = new CustomLabel(context.game, bedbugGameCore.autoplay_count, 57, 0, 30, 25, false, autoplayCount_style);
        this.autoplay_label.resolution = 2;
        this.autoplay_Stop_label = new CustomLabel(context.game, bedbugGameCore.autoplay_count, 57, 0, 30, 25, false, autoplayCount_style);
        this.autoplay_Stop_label.resolution = 2;

        this.coins_label = new CustomLabel(context.game, "500000", 935, 663, 100, 40);
        this.coin_value_label = new CustomLabel(context.game, "0.01", 1067, 663, 46, 40);
        this.bet_level_label = new CustomLabel(context.game, "0.01", 210, 663, 46, 40);
        this.bet_label = new CustomLabel(context.game, "20", 345, 663, 100, 40);
        ...
        this.betlevel_heading = context.game.add.bitmapText(215, 625, "contrail_small", bedbugGameCore.getLocalizedText('TXT_BET_LEVEL_LABEL'), 20);
        this.betlevel_heading.anchor.setTo(0.5, 0);


        this.bet_heading = context.game.add.bitmapText(345, 625, "contrail_small", bedbugGameCore.getLocalizedText("TXT_BET_LABEL"), 20);
        this.bet_heading.anchor.setTo(0.5, 0);


        this.coins_heading = context.game.add.bitmapText(935, 625, "contrail_small", bedbugGameCore.getLocalizedText("TXT_COINS_LABEL"), 20);
        this.coins_heading.anchor.setTo(0.5, 0);


        this.coin_value_heading = context.game.add.bitmapText(1067, 625, "contrail_small", bedbugGameCore.getLocalizedText("TXT_COIN_VALUE_LABEL"), 20);
    ...
    createAutoplayPanel: function(context) {
        ...
        this.autoplay_Panel_Bg = bedbugGameCore.game.add.sprite(150, -10, "assets", "Autoplay_panel.png");
        ...
        this.autoplay_Panel_Bg2 = bedbugGameCore.game.add.sprite(-15, -40, "assets", "Autoplay_panel_second.png");
        ...
        this.autoplay_panel.x = bedbugGameCore.game.width / 2 - 400;
        ...
        this.autoplay_stepper = new Stepper(context.game, null, bedbugGameCore.autoplay_count, context.decrAutoplayCount, context.incrAutoplayCount, (width / 2), 61, 0, 0, true, {
            ...
            true, "assets", "TextBox_Small.png", "arrow", true, -122
        );
        ...
        this.advancedOptions = context.game.add.button(250, 105, 'assets', openAutoplayPanel2, this, 'button-autoplay-panel-over.png', 'button-autoplay-panel-active.png', 'button-autoplay-panel-pressed.png', 'button-autoplay-panel-active.png');
        ...
        this.startAuto = context.game.add.button(250, 140, 'assets', startAutoplayPanel, this, 'button-autoplay-panel-over.png', 'button-autoplay-panel-active.png', 'button-autoplay-panel-pressed.png', 'button-autoplay-panel-active.png');
        ...
        this.stop_any_text = context.game.add.bitmapText(25, 0, "contrail_small", bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_ANY"), 15);
        ...
        this.stop_win_text = context.game.add.bitmapText(25, 0, "contrail_small", bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_WIN_AMOUNT"), 15);
        ...
        this.stop_cash_text = context.game.add.bitmapText(25, 0, "contrail_small", bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_WIN_CASH"), 15);
        ...
        this.stop_time_text = context.game.add.bitmapText(25, 0, "contrail_small", bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_TIME"), 15);
        ...
        this.stop_lose_text = context.game.add.bitmapText(25, 0, "contrail_small", bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_LOSE"), 15);
