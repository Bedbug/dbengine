Controls = {
    create: function(context) {
        ...
        this.home_button = context.game.add.button(20, 20, 'mobile', bedbugGameCore.GO_HOME, bedbugGameCore, 'Home_Active.png', 'Home_Active.png', 'Home_Pressed.png');
        ...
        // // SETTINGS BUTTON
        this.settings_button = context.game.add.button(1180, 20, 'mobile', this.openOptionsPanel, this, 'Options_Active.png', 'Options_Active.png', 'Options_Pressed.png');
        ...
        this.paytable_button = context.game.add.button(210, 683, 'mobile', context.showPayTable, context, 'button_Active.png', 'button_Active.png', 'button_Pressed.png');
        ...
        // SET BET BUTTON
        this.set_bet_button = context.game.add.button(719, 683, 'mobile', this.openBetPanel, this, 'button_Active.png', 'button_Active.png', 'button_Pressed.png');
        ...
        this.autoplay_button = context.game.add.button(973, 683, 'mobile', this.openAutoplayPanel, this, 'button_Active.png', 'button_Active.png', 'button_Pressed.png');
        ...
        this.autoplay_stop_button = context.game.add.button(973, 683, 'mobile', context.controls_stop_auto, context, 'button_Active.png', 'button_Active.png', 'button_Pressed.png');
        ...
        // this.autoplay_count = new CustomButton(context.game, "", this.autoplay_button.x, this.autoplay_button.y , 80, 50, null, null, false, {
        //     font: "bold 20px Arial",
        //     bgColor: 0x000000,
        //     backgroundAlpha: 0.5
        // }, false, true);
        ...
        // });
        this.balance_label_heading = context.game.add.text(450, 15, bedbugGameCore.getLocalizedText("TXT_BALANCE_LABEL"), {
            font: "17px Arial",
            fill: "#EAEAEA"
        });
        ...
        // Bet
        this.bet_heading = context.game.add.text(650, 15, bedbugGameCore.getLocalizedText("TXT_BET_LABEL"), {
            font: "17px Arial",
            fill: "#EAEAEA"
        ...
        this.win_label_heading = context.game.add.text(800, 15, bedbugGameCore.getLocalizedText("TXT_WIN_LABEL"), {
            font: "17px Arial",
            fill: "#EAEAEA",
        });
        ...
        this.game_time = context.game.add.text(1060, 15, "", {
            font: "17px Arial",
            fill: "#EAEAEA",
        });
        ...
        this.play_button = context.game.add.button(1180, 635, 'mobile', context.play_spin, context, 'Spin_Active.png', 'Spin_Active.png', 'Spin_Pressed.png');
        ...
        this.countplay_button_stop = context.game.add.button(0, 0, 'mobile', context.play_spin, context, 'Spin_Active.png', 'Spin_Active.png', 'Spin_Pressed.png');
    ...
    createAutoplayPanel: function(context) {
        ...
        this.advancedOptions = context.game.add.button(30, 480, 'mobile', openAutoplayPanel2, this, 'btn_advanced_active.png', 'btn_advanced_active.png', 'btn_advanced_pressed.png');
        ...
        this.advancedOptions = context.game.add.button(450, 480, 'mobile', startAutoplayPanel, this, 'btn_advanced_active.png', 'btn_advanced_active.png', 'btn_advanced_pressed.png');
        this.advancedOptions.anchor.setTo(0.5, 0.5);
        ...
        // ADD CLOSE BUTTON
        this.backToGame = context.game.add.button(740, 15, 'mobile', closeAutoplayPanel, this, 'btn_close_active.png', 'btn_close_active.png', 'btn_close_pressed.png');
        ...
        // STOP AT LOSE
        this.stop_lose = new CheckΒox(280, 500, context.game, null, bedbugGameCore.autoplay_setup.on_lose.value, bedbugGameCore.autoplay_setup.on_lose.checked, _.merge(options, { isMoney: true, isTime: false, description: bedbugGameCore.getLocalizedText("TXT_AUTOPLAY_STOP_LOSE") }), function(o, e) {
        ...
        // ADD Back BUTTON
        this.backToAutoplay = context.game.add.button(740, 15, 'mobile', closeAutoplayPanel2, this, 'btn_back_active.png', 'btn_back_active.png', 'btn_back_pressed.png');
    ...
    createBetPanel: function(context) { // Themis Popup to change
        ...
        // ADD CLOSE BUTTON
        this.closeBet = context.game.add.button(847, -5, 'mobile', closeABetPanel, this, 'btn_close_active.png', 'btn_close_active.png', 'btn_close_pressed.png');
        ...
        // ADD BUTTON MAX BET
        this.max_bet_button = context.game.add.button(165, 465, 'mobile', context.setMaxBet, context, 'btn_maxbet_active.png', 'btn_maxbet_active.png', 'btn_maxbet_pressed.png');
    ...
    createPaytable: function(context) {
        ...
        // SCATTER SYMBOL
        var scattersymbol = getSymbol(bedbugGameCore.symbolNameToID("SCAT"), left + 100, 180, 130, "20 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"), "15 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"), "10 " + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02"));
        ...
        var symbol6 = getSymbol(bedbugGameCore.symbolNameToID("L5"), left + 95, 200, 130, getAward("L5", "5"), getAward("L5", "4"), getAward("L5", "3"), false);
        ...
        var paylines = context.game.add.sprite(panel_width / 2 + 45, panel_height / 2 - 30, "mobile", "Page 04_paylines.png");
        paylines.anchor.setTo(.5);
        paylines.scale.setTo(.90);
        ...
        // CLOSE BUTTON
        var close_button = bedbugGameCore.game.add.button(panel_x + 90, panel_y + panel_height - 30, 'mobile', hidePaytable, this, 'btn_close_active.png', 'btn_close_active.png', 'btn_close_pressed.png');
        close_button.anchor.setTo(.5, .5);
        close_button.scale.setTo(0.5, 0.5);
        close_button.alpha = 0;

        this.close_button2 = bedbugGameCore.game.add.button(1136, 63, 'mobile', hidePaytable, this, 'btn_close_active.png', 'btn_close_active.png', 'btn_close_pressed.png');
        ...
        this.chevronRight = bedbugGameCore.game.add.button(50, 0, 'mobile', chevronRightPress, this, 'paytable_arrow_right_active.png', 'paytable_arrow_right_active.png', 'paytable_arrow_right_pressed.png');
        //chevronRight.scale.setTo(0.5, 0.5);

        this.chevronRight.x = 1055;
        this.chevronRight.y = 220;
        this.chevronRight.scale.setTo(1.0, 1.0);
        this.chevronRight.visible = false;
        ...
        this.chevronLeft = bedbugGameCore.game.add.button(50, 0, 'mobile', chevronLeftPress, this, 'paytable_arrow_left_active.png', 'paytable_arrow_left_active.png', 'paytable_arrow_left_pressed.png');
        //chevronLeft.scale.setTo(0.5, 0.5);

        this.chevronLeft.x = 145;
        this.chevronLeft.y = 220;
        this.chevronLeft.scale.setTo(1.0, 1.0);
        this.chevronLeft.visible = false;
