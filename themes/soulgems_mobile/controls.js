Controls = {
    create: function(context) {
        ...
        this.home_button = context.game.add.button(20, 20, 'mobile', bedbugGameCore.GO_HOME, bedbugGameCore, 'button_home_active.png', 'button_home_active.png', 'button_home_pressed.png');
        ...
        this.homeOff_button.frameName = "button_home_inactive.png";
        this.controlsGroup.addChild(this.homeOff_button);
        this.buttonsOffArray.push(this.homeOff_button);

        // // SETTINGS BUTTON
        this.settings_button = context.game.add.button(1180, 20, 'mobile', this.openOptionsPanel, this, 'button_options_active.png', 'button_options_active.png', 'button_options_pressed.png');
        ...
        this.settingsOff_button.frameName = "button_options_inactive.png";
        this.controlsGroup.addChild(this.settingsOff_button);
        this.buttonsOffArray.push(this.settingsOff_button);

        this.paytable_button = context.game.add.button(210, 683, 'mobile', context.showPayTable, context, 'button_paytable_active.png', 'button_paytable_active.png', 'button_paytable_pressed.png');
        ...
        this.paytableOff_button.frameName = "button_paytable_inactive.png";
        ...
        this.coinsTextBox.frameName = "textbox_gui.png";
        ...
        // SET BET BUTTON
        this.set_bet_button = context.game.add.button(719, 683, 'mobile', this.openBetPanel, this, 'button_paytable_active.png', 'button_paytable_active.png', 'button_paytable_pressed.png');
        ...
        this.set_betOff_button.frameName = 'button_paytable_inactive.png';
        ...
        this.autoplay_button = context.game.add.button(973, 683, 'mobile', this.openAutoplayPanel, this, 'button_paytable_active.png', 'button_paytable_active.png', 'button_paytable_pressed.png');
        ...
        this.autoplayOff_button.frameName = "button_paytable_inactive.png";
        ...
        this.autoplay_stop_button = context.game.add.button(973, 683, 'mobile', context.controls_stop_auto, context, 'button_paytable_active.png', 'button_paytable_active.png', 'button_paytable_pressed.png');
        ...
        // });
        this.balance_label_heading = context.game.add.text(320, 18, bedbugGameCore.getLocalizedText("TXT_BALANCE_LABEL"), {
            font: "17px Arial",
            fill: "#EAEAEA"
        });
        ...
        // Bet
        this.bet_heading = context.game.add.text(540, 18, bedbugGameCore.getLocalizedText("TXT_BET_LABEL"), {
            font: "17px Arial",
            fill: "#EAEAEA"
        ...
        this.win_label_heading = context.game.add.text(750, 18, bedbugGameCore.getLocalizedText("TXT_WIN_LABEL"), {
            font: "17px Arial",
            fill: "#EAEAEA",
        });
        ...
        this.game_time = context.game.add.text(1040, 18, "", {
            font: "17px Arial",
            fill: "#EAEAEA",
        });
        ...
        this.play_button = context.game.add.button(1180, 635, 'mobile', context.play_spin, context, 'button_spin_active.png', 'button_spin_active.png', 'button_spin_pressed.png');
        ...
        this.playOff_button.frameName = "button_spin_inactive.png";
        ...
        this.countplay_button_stop = context.game.add.button(0, 0, 'mobile', context.play_spin, context, 'button_spin_active.png', 'button_spin_active.png', 'button_spin_pressed.png');
    ...
    createOptions: function(context) {
        ...
        // ADD CLOSE BUTTON
        this.closeOptions = context.game.add.button(720, 24, 'mobile', closeOptions, this, 'btn_options_close_active.png', 'btn_options_close_active.png', 'btn_options_close_pressed.png');
    ...
    createAutoplayPanel: function(context) {
        ...
        // ADD CLOSE BUTTON
        this.backToGame = context.game.add.button(740, 15, 'mobile', closeAutoplayPanel, this, 'btn_options_close_active.png', 'btn_options_close_active.png', 'btn_options_close_pressed.png');
        ...
        // ADD Back BUTTON
        this.backToAutoplay = context.game.add.button(740, 15, 'mobile', closeAutoplayPanel2, this, 'btn_options_back_active.png', 'btn_options_back_active.png', 'btn_options_back_pressed.png');
    ...
    createBetPanel: function(context) { // Themis Popup to change
        ...
        // ADD CLOSE BUTTON
        this.closeBet = context.game.add.button(847, -5, 'mobile', closeABetPanel, this, 'btn_options_close_active.png', 'btn_options_close_active.png', 'btn_options_close_pressed.png');
    ...
    createPopupBG: function(game, width, height, shouldCloseExternalClick, style, onClickOutsideCallback) {
        ...
        if (!prestyle.isGradient) {
            ...
            var panel_background = game.add.sprite(0, 0, "mobile", "board_paytable.png");
            panel_background.inputEnabled = true;
    ...
    createPaytable: function(context) {
        ...
        // WILD SYMBOL
        var info1 = context.game.add.text(panel_width / 2 + 40, 55, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_01"), {
            'font': ' 22px Arial',
            'fill': '#fff',
            'align': 'center',
        ...
        // // SCATTER SYMBOL
        var scattersymbol = getSymbol(bedbugGameCore.symbolNameToID("WILD"), left + 250, 160, 150);

        var info2 = context.game.add.text(scattersymbol.x, scattersymbol.y + 90, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_02") + "\n\n" + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_03") + "\n\n" + bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_04"), {
            'font': ' 22px Arial',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        info2.lineSpacing = -5;
        info2.resolution = 2;
        var info3 = context.game.add.text((panel_width) - 80, 120, bedbugGameCore.getLocalizedText("TXT_PAYTABLE_PAGE_01_INFO_05"), {
            'font': ' 22px Arial',
            'fill': '#fff',
            'align': 'center',
            wordWrap: true,
        ...
        var diamonds_stacked1 = context.game.add.sprite((panel_width) - 230, 160, "assets2", "diamonds_stacked.png");
        var diamonds_stacked2 = context.game.add.sprite((panel_width) - 120, 160, "assets2", "diamonds_stacked.png");
        var diamonds_stacked3 = context.game.add.sprite((panel_width) - 10, 160, "assets2", "diamonds_stacked.png");
        ...
        // CLOSE BUTTON
        var close_button = bedbugGameCore.game.add.button(panel_x + 90, panel_y + panel_height - 30, 'mobile', hidePaytable, this, 'btn_options_close_active.png', 'btn_options_close_active.png', 'btn_options_close_pressed.png');
        close_button.anchor.setTo(.5, .5);
        close_button.scale.setTo(0.5, 0.5);
        close_button.alpha = 0;

        this.close_button2 = bedbugGameCore.game.add.button(1136, 63, 'mobile', hidePaytable, this, 'btn_options_close_active.png', 'btn_options_close_active.png', 'btn_options_close_pressed.png');
        ...
        context.drawBullets = function(index) {
            ...
            _.times(context.panel_pages, function(i) {
                ...
                if (i == index) {
                    ...
                    bullets.frameName = "page_navigation_pressed.png";
                }
                else {

                    bullets.frameName = "page_navigation_inactive.png";
                }
