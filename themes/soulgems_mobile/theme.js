Theme = {
    ...
    create: function(context) {
        ...
        context.game.time.events.loop(Phaser.Timer.SECOND * 1, rollingBg, this);
        this.bgCount = 1;
        this.countMinus = 0;
        rollingBg();
        ...
        function rollingBg() {
            ...
            context.game.add.tween(that.floatingBgs[that.countMinus]).to({
                alpha: 0
            }, 1000, Phaser.Easing.Linear.None, true, 2000);
            context.game.add.tween(that.floatingBgs[that.bgCount]).to({
                alpha: 1
            ...
            if (that.bgCount == 6) that.bgCount = 0;
            if (that.countMinus == 6) that.countMinus = 0;
        }
        ...
        this.game_background = context.game.add.sprite(0, 0, 'mobile');
        this.game_background.frameName = "gameBackground.png";
