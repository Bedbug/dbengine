Splash = {
    create: function(context) {
       ...
       var extraText = context.game.add.text( 880, 240, bedbugGameCore.getLocalizedText("TXT_FTHS_INFO_04"), {
        ...
        context.continue_text = context.game.add.text(context.game.width/2 , 615,  bedbugGameCore.getLocalizedText('CONTINUE_LABEL'), buttonTextStyle);
        
        context.continue_text.setShadow(0, 4, 'rgba(0,0,0,0.2)', 0);
