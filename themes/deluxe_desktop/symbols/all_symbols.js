  ...
  slot1 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'Seven-Norm.png', 'Seven', 'assets', "Plain", true, null, false, true);
     this.symbolName = "P4";
  }
  ...
  slot2 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'Bell-Norm.png', 'Bell', 'assets2', "Plain", true, null, false, true);
    this.symbolName = "P3";
  }
  ...
  slot3 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'HorseShoe-Norm.png', 'HorseShoe', 'assets2', "Plain", true, null, false, true);
    this.symbolName = "P2";
  }
  ...
  slot4 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'Bar-Norm.png', 'Bar', 'assets', "Plain", true, null, false, true);
    this.symbolName = "P1";
  }
  ...
  slot5 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'Cherries-Norm.png', 'Cherries', 'assets2', "Low", true, null, false, true);
    this.symbolName = "L4";
  }
  ...
  slot6 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'Lemon-Norm.png', 'Lemon',  "assets2", "Low", true, null, false, true);
    this.symbolName = "L3";
  }
  ...
  slot7 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'Grappes-Norm.png', 'Grappes', "assets2", "Low", true, null, false, true);
    this.symbolName = "L2";
  }
  ...
  slot8 = function(game, positionAsName, x, y, width, height) {
    BBSlot.call(this, game, positionAsName, x, y, width, height, 'Orange-Norm.png', 'Orange', "assets2", "Low", true, null, false, true);
    this.symbolName = "L1";
  }
  ...
  ************************************************************************/
   ...
   ************************************************************************/
  // slot9 = function(game, positionAsName, x, y, width, height) {
  //   BBSlot.call(this, game, positionAsName, x, y, width, height, 'Orange-Norm.png', 'Orange', 'assets2', "Wild", true, null, false, true);
  ...
  //   BBSlot.call(this, game, positionAsName, x, y, width, height, 'Bar-Norm.png', 'Bar', 'assets', "Scatter", true, null, false, true);
