var Stepper = function(game, stepperLabel, initValue, leftCallback, rightCallback, x, y, width, height, isDraggable, prestyle, isAtlas, spritesheet, spritebox, spritearrow, notDisabled, buttonsDist) {
    ...
    if(!isAtlas || isAtlas == null) {
        this.chevronLeft = bedbugGameCore.game.add.image(-(width / 2 - 40), 0, "slider_chevron_left");
        this.chevronLeft.anchor.setTo(0.5, 0.5);
        this.chevronLeft.scale.setTo(1, 1);
        ...
        this.chevronRight = bedbugGameCore.game.add.image((width / 2 - 40), 0, "slider_chevron_right");
        this.chevronRight.anchor.setTo(0.5, 0.5);
        this.chevronRight.scale.setTo(1, 1);
        ...
        // console.log(this.cacheX);
        // console.log(this.cacheWidth);
        if(this.buttonsDist == null)
            this.buttonsDist = 0;
        this.chevronLeft = bedbugGameCore.game.add.button((-170 - this.buttonsDist),0, this.spritesheet, this.leftCallback, this, this.spritearrow+'---over.png', this.spritearrow+'---active.png', this.spritearrow+'---pressed.png',this.spritearrow+'---active.png');
        this.chevronLeft.anchor.setTo(0.5, 0.5);
        this.chevronLeftinActive = bedbugGameCore.game.add.sprite( (-170 - this.buttonsDist) ,0, this.spritesheet);
        this.chevronLeftinActive.frameName = this.spritearrow+'---inactive.png';
        this.chevronLeftinActive.anchor.setTo(0.5, 0.5);
        this.chevronLeftinActive.visible = false;
        
        this.chevronRight = bedbugGameCore.game.add.button( (170+this.buttonsDist) ,0, this.spritesheet, this.rightCallback, this, this.spritearrow+'-+-over.png', this.spritearrow+'-+-active.png', this.spritearrow+'-+-pressed.png', this.spritearrow+'-+-active.png');
        this.chevronRight.anchor.setTo(0.5, 0.5);
        this.chevronRightinActive = bedbugGameCore.game.add.sprite( (170+this.buttonsDist) ,0, this.spritesheet);
...
Stepper.prototype = Object.create(Phaser.Graphics.prototype);

Stepper.prototype.constructor = Stepper;
Stepper.prototype.setLabel = function(label, leftDisabled, rightDisabled) {
